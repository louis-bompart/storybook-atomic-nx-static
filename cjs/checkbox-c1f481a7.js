...
const Checkbox = (props) => {
    ...
    return (index.h("button", { ...attributes, role: "checkbox", onClick: () => { var _a; return (_a = props.onToggle) === null || _a === void 0 ? void 0 : _a.call(props, !props.checked); }, onMouseDown: (e) => { var _a; return (_a = props.onMouseDown) === null || _a === void 0 ? void 0 : _a.call(props, e); } },
        index.h("atomic-icon", { style: { stroke: 'white' }, class: `w-3/5 ${props.checked ? 'block' : 'hidden'}`, icon: Tick, part: props.iconPart })));
};

exports.Checkbox = Checkbox;
exports.Tick = Tick;

//# sourceMappingURL=checkbox-c1f481a7.js.map