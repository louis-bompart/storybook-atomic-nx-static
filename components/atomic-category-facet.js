...
import { K as KO, E as EE, _ as _T } from './headless.esm.js';
import { A as AriaLiveRegion, F as FocusTargetController } from './accessibility-utils.js';
import { g as getFieldValueCaption, a as getFieldCaptions } from './field-utils.js';
import { I as InitializeBindings, B as BindStateToController } from './initialization-utils.js';
import { A as ArrayProp, M as MapProp } from './props-utils.js';
import { A as ArrowLeftIcon } from './arrow-left-rounded.js';
import { B as Button } from './button.js';
import { F as FacetValueLabelHighlight, s as shouldUpdateFacetSearchComponent, a as shouldDisplaySearchResults } from './facet-value-label-highlight.js';
...
const CategoryFacetChildrenAsTreeContainer = ({ className }, children) => {
    return (h("ul", { part: "values", class: className !== null && className !== void 0 ? className : '' }, children));
};

const CategoryFacetParentAsTreeContainer = ({ isTopLevel, className }, children) => {
    return (h("ul", { class: className !== null && className !== void 0 ? className : '', part: `${isTopLevel ? '' : 'sub-'}parents` }, children));
};
    ...
    function renderPath(path) {
        ...
        return [
            ...
            ellipsedPath(path).map((value, index) => [
                ...
                h("span", { class: value === ELLIPSIS ? '' : 'truncate flex-1 max-w-max' }, value),
            ]),
        ];
    }
    return (h("li", { key: value.displayValue },
        h(Button, { style: "text-neutral", part: "search-result", onClick: () => onClick(), class: "w-full flex flex-col px-2 py-2.5 truncate group no-outline", "aria-label": ariaLabel },
            ...
            h("div", { part: "search-result-path", class: "flex w-full text-neutral-dark mt-1 group-focus:text-primary group-hover:text-primary" }, renderPath(localizedPath)))));
};
...
const AtomicCategoryFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicCategoryFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    initialize() {
        ...
        this.facet = EE(this.bindings.engine, { options });
    ...
    renderHeader() {
        return (h(FacetHeader, { i18n: this.bindings.i18n, label: this.label, numberOfActiveValues: this.facetState.hasActiveValues && this.isCollapsed ? 1 : 0, isCollapsed: this.isCollapsed, headingLevel: this.headingLevel, onToggleCollapse: () => (this.isCollapsed = !this.isCollapsed), onClearFilters: () => {
    ...
    renderValuesTree(parents, isRoot) {
        ...
        if (isRoot) {
            return (h(CategoryFacetTreeValueContainer, null, h(CategoryFacetAllCategoryButton, { i18n: this.bindings.i18n, onClick: () => {
                    ...
                    this.facet.deselectAll();
                } }), h(CategoryFacetParentAsTreeContainer, { isTopLevel: false }, this.renderValuesTree(parents, false))));
        }
        if (parents.length > 1) {
            const parentValue = parents[0];
            return (h(CategoryFacetTreeValueContainer, null, h(CategoryFacetParentButton, { facetValue: parentValue, field: this.field, i18n: this.bindings.i18n, onClick: () => {
                    this.focusTargets.activeValueFocus.focusAfterSearch();
                    this.facet.toggleSelect(parentValue);
                } }), h(CategoryFacetParentAsTreeContainer, { isTopLevel: false }, this.renderValuesTree(parents.slice(1), false))));
        }
        const activeParent = parents[0];
        const activeParentDisplayValue = getFieldValueCaption(this.field, activeParent.value, this.bindings.i18n);
        return (h(CategoryFacetParentValueLink, { displayValue: activeParentDisplayValue, numberOfResults: activeParent.numberOfResults, i18n: this.bindings.i18n, isLeafValue: activeParent.isLeafValue, onClick: () => {
                this.focusTargets.activeValueFocus.focusAfterSearch();
                this.facet.deselectAll();
            }, searchQuery: this.facetState.facetSearch.query, setRef: (el) => this.focusTargets.activeValueFocus.setTarget(el) }, h(CategoryFacetChildrenAsTreeContainer, null, this.renderChildren())));
    }
    renderChild(facetValue, isShowLessFocusTarget, isShowMoreFocusTarget) {
        ...
        return (h(CategoryFacetChildValueLink, { displayValue: displayValue, i18n: this.bindings.i18n, isLeafValue: facetValue.isLeafValue, isSelected: isSelected, numberOfResults: facetValue.numberOfResults, onClick: () => {
                this.focusTargets.activeValueFocus.focusAfterSearch();
    ...
    renderShowMoreLess() {
        return (h("div", { class: this.hasParents ? 'pl-9' : '' }, h(FacetShowMoreLess, { label: this.label, i18n: this.bindings.i18n, onShowMore: () => {
    ...
    static get style() { return AtomicCategoryFacetStyle0; }
}, [1, "atomic-category-facet", {
        ...
        "delimitingCharacter": [513, "delimiting-character"],
        "basePath": [1537, "base-path"],
        "filterByBasePath": [516, "filter-by-base-path"],
...
__decorate([
    InitializeBindings()
], AtomicCategoryFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facet')
], AtomicCategoryFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicCategoryFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    ArrayProp()
], AtomicCategoryFacet$1.prototype, "basePath", void 0);
__decorate([
    MapProp()
], AtomicCategoryFacet$1.prototype, "dependsOn", void 0);
__decorate([
    AriaLiveRegion('facet-search')
], AtomicCategoryFacet$1.prototype, "facetSearchAriaMessage", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-category-facet", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-category-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicCategoryFacet$1);
            }
            break;
...
const AtomicCategoryFacet = AtomicCategoryFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicCategoryFacet, defineCustomElement };

//# sourceMappingURL=atomic-category-facet.js.map