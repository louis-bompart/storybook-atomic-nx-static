...
const AtomicResultTimespan = class {
    ...
    render() {
        const duration = dayjs.duration(this.value, this.unit);
        if (this.format) {
    ...
    get value() {
        return ResultTemplatesHelpers.getResultProperty(this.result, this.field);
    }
};
__decorate([
    InitializeBindings()
...
export { AtomicResultTimespan as atomic_result_timespan };

//# sourceMappingURL=atomic-result-timespan.entry.js.map