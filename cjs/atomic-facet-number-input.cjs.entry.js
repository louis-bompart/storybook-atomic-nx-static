...
const FacetNumberInput = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '1b88a7239f15faafc74a0210942af1831acebc51', class: "mt-4 px-2 gap-y-0.5", part: "input-form", onSubmit: (e) => {
                e.preventDefault();
                this.apply();
                return false;
            } }, index.h("label", { key: '4d013056d8fa0a1c474ba044982c724fafc6b8cd', part: "label-start", class: labelClasses, htmlFor: `${this.filterState.facetId}_start` }, minText), index.h("input", { key: '253c7cbc2df9ac20e766b01a1e9cbafa9684b8b9', part: "input-start", id: `${this.filterState.facetId}_start`, type: "number", step: step, ref: (ref) => (this.startRef = ref), class: inputClasses, "aria-label": minAria, required: true, min: Number.MIN_SAFE_INTEGER, max: this.end, value: (_a = this.filterState.range) === null || _a === void 0 ? void 0 : _a.start, onInput: (e) => (this.start = e.target.valueAsNumber) }), index.h("label", { key: '290eedfcf067aecdd7759deef0ea13ed28b446c3', part: "label-end", class: labelClasses, htmlFor: `${this.filterState.facetId}_end` }, maxText), index.h("input", { key: '2a73acd3d062b420c1702a1391315c0a41914b21', part: "input-end", id: `${this.filterState.facetId}_end`, type: "number", step: step, ref: (ref) => (this.endRef = ref), class: inputClasses, "aria-label": maxAria, required: true, min: this.start, max: Number.MAX_SAFE_INTEGER, value: (_b = this.filterState.range) === null || _b === void 0 ? void 0 : _b.end, onInput: (e) => (this.end = e.target.valueAsNumber) }), index.h(button.Button, { key: '2c8aa2d4dba5cee48b7bc2064a2fb3d22275c8ab', style: "outline-primary", type: "submit", part: "input-apply-button", class: "p-2.5 flex-none truncate", ariaLabel: applyAria, text: apply })));
    }
};
