...
const AtomicResultIcon = class {
    ...
    get icon() {
        const fileTypeValue = headless_esm.ow.getResultProperty(this.result, 'filetype');
        const objectTypeValue = headless_esm.ow.getResultProperty(this.result, 'objecttype');
    ...
    renderIcon() {
        ...
        const backgroundColor = bgStandard_common[utils.snakeToCamel(icon)] || 'transparent';
        return (index.h("atomic-icon", { icon: 'assets://' + icon, class: icon, title: icon, style: { backgroundColor } }));
    }
    render() {
        return this.icon ? this.renderIcon() : index.h("slot", null, this.renderIcon());
    }
...
exports.atomic_result_icon = AtomicResultIcon;

//# sourceMappingURL=atomic-result-icon.cjs.entry.js.map