...
import { S as Schema, c as StringValue } from './bueno.esm.js';
import { K as KO, i as eI, x as xs, k as oI, _ as _T, n as rge } from './headless.esm.js';
...
import { b as shouldDisplayInputForFacetRange } from './facet-common.js';
...
import { f as formatHumanReadable, N as NumericFacetValuesContainer, a as NumericFacetValueLink } from './values-container.js';
...
const AtomicNumericFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicNumericFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
         ...
         */
        this.rangeAlgorithm = 'equiprobable';
        /**
        ...
        this.facetForInputState = undefined;
        this.facetId = undefined;
        this.label = 'no-label';
        this.field = undefined;
        this.numberOfValues = 8;
        this.withInput = undefined;
        this.sortCriteria = 'ascending';
        this.rangeAlgorithm = 'equiprobable';
        this.displayValuesAs = 'checkbox';
        this.isCollapsed = false;
    ...
    initializeFacetForInput() {
        if (!this.withInput) {
            return;
        }
        this.facetForInput = eI(this.bindings.engine, {
            options: {
                numberOfValues: 1,
    ...
    initializeFacetForRange() {
        if (this.numberOfValues <= 0) {
            return;
        }
        this.manualRanges = Array.from(this.host.querySelectorAll('atomic-numeric-range')).map(({ start, end, endInclusive, label }) => ({
            ...xs({ start, end, endInclusive }),
            label,
        }));
        this.facetForRange = eI(this.bindings.engine, {
            options: {
    ...
    initializeFilter() {
        ...
        this.filter = oI(this.bindings.engine, {
            options: {
    ...
    initializeDependenciesManager() {
        ...
        this.dependenciesManager = _T(this.bindings.engine, {
            facetId: (_b = (_a = this.facetForRange) === null || _a === void 0 ? void 0 : _a.state.facetId) !== null && _b !== void 0 ? _b : this.filter.state.facetId,
    ...
    applyNumberInput() {
        this.facetId &&
            this.bindings.engine.dispatch(rge(this.bindings.engine).deselectAllNumericFacetValues(this.facetId));
    }
    render() {
        const { searchStatusState: { firstSearchExecuted, hasError }, bindings: { i18n }, } = this;
        return (h(FacetGuard, { key: '81b2041548b541c50346f5ccfbe2db28d0b4cf1b', enabled: this.enabled, firstSearchExecuted: firstSearchExecuted, hasError: hasError, hasResults: this.shouldRenderFacet }, firstSearchExecuted ? (h(FacetContainer, null, h(FacetHeader, { i18n: i18n, label: this.label, onClearFilters: () => {
                var _a, _b, _c;
                ...
                (_c = this.facetForRange) === null || _c === void 0 ? void 0 : _c.deselectAll();
            }, numberOfActiveValues: this.numberOfSelectedValues, isCollapsed: this.isCollapsed, headingLevel: this.headingLevel, onToggleCollapse: () => (this.isCollapsed = !this.isCollapsed), headerRef: (el) => this.focusTarget.setTarget(el) }), !this.isCollapsed && [
            this.shouldRenderValues && this.renderValues(),
            this.shouldRenderInput && (h("atomic-facet-number-input", { type: this.withInput, bindings: this.bindings, label: this.label, filter: this.filter, filterState: this.filter.state })),
        ])) : (h(FacetPlaceholder, { isCollapsed: this.isCollapsed, numberOfValues: this.numberOfValues }))));
    }
    renderValues() {
        const { displayValuesAs, field, manualRanges, label, bindings: { i18n, engine: { logger }, }, formatter, } = this;
        return (h(NumericFacetValuesContainer, { i18n: i18n, label: label }, this.valuesToRender.map((value) => (h(NumericFacetValueLink, { formatter: formatter, displayValuesAs: displayValuesAs, facetValue: value, field: field, i18n: i18n, logger: logger, manualRanges: manualRanges, onClick: () => this.displayValuesAs === 'link'
    ...
    get numberOfSelectedValues() {
        ...
        return (((_b = this.facetForRange) === null || _b === void 0 ? void 0 : _b.state.values.filter(({ state }) => state === 'selected').length) || 0);
    }
    ...
    get valuesToRender() {
        var _a;
        return (((_a = this.facetForRange) === null || _a === void 0 ? void 0 : _a.state.values.filter((value) => value.numberOfResults || value.state !== 'idle')) || []);
    }
    get shouldRenderInput() {
        ...
        return shouldDisplayInputForFacetRange({
            ...
            facetValues: ((_a = this.facetForInput) === null || _a === void 0 ? void 0 : _a.state.values) || [],
    ...
    get enabled() {
        var _a, _b, _c, _d;
        return (_d = (_b = (_a = this.facetState) === null || _a === void 0 ? void 0 : _a.enabled) !== null && _b !== void 0 ? _b : (_c = this.filter) === null || _c === void 0 ? void 0 : _c.state.enabled) !== null && _d !== void 0 ? _d : true;
    }
    get isHidden() {
    ...
    get hasValues() {
        var _a;
        if ((_a = this.facetForInput) === null || _a === void 0 ? void 0 : _a.state.values.length) {
            return true;
        }
    ...
    static get style() { return AtomicNumericFacetStyle0; }
}, [1, "atomic-numeric-facet", {
        "facetId": [1537, "facet-id"],
        "label": [513],
        "field": [513],
        "numberOfValues": [514, "number-of-values"],
        "withInput": [513, "with-input"],
        "sortCriteria": [513, "sort-criteria"],
        "rangeAlgorithm": [513, "range-algorithm"],
        ...
        "error": [32],
        "facetForInputState": [32]
    }, [[0, "atomic/numberFormat", "setFormat"], [0, "atomic/numberInputApply", "applyNumberInput"]]]);
__decorate([
    InitializeBindings()
], AtomicNumericFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facetForRange')
], AtomicNumericFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('filter')
], AtomicNumericFacet$1.prototype, "filterState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicNumericFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    BindStateToController('facetForInput')
], AtomicNumericFacet$1.prototype, "facetForInputState", void 0);
__decorate([
    MapProp()
], AtomicNumericFacet$1.prototype, "dependsOn", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-numeric-facet", "atomic-component-error", "atomic-facet-number-input", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-numeric-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicNumericFacet$1);
            }
            break;
...
const AtomicNumericFacet = AtomicNumericFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicNumericFacet, defineCustomElement };

//# sourceMappingURL=atomic-numeric-facet.js.map