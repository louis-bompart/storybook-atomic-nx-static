...
import { g as getBasePlacement, m as mergePaddingObject, e as expandToHashMap, b as basePlacements, a as getLayoutRect, c as getOffsetParent, w as within, d as contains, f as getMainAxisFromPlacement, t as top, l as left, h as bottom, r as right, i as getVariation, v as variationPlacements, j as detectOverflow, p as placements, k as auto, s as start, n as popperGenerator, o as eventListeners, q as popperOffsets, u as computeStyles, x as applyStyles, y as preventOverflow } from './createPopper.js';
...
const AtomicCitation$1 = /*@__PURE__*/ proxyCustomElement(class AtomicCitation extends HTMLElement {
    ...
    getTruncatedText() {
        ...
        return (this.citation.text &&
            `${(_a = this.citation.text) === null || _a === void 0 ? void 0 : _a.trim().slice(0, 200)}${this.citation.text.length > 200 ? '...' : ''}`);
    }
    renderPopover() {
        return (h("div", { part: "citation-popover", class: `rounded-md border border-neutral p-4 shadow z-10 bg-background ${this.isOpen ? 'desktop-only:flex' : 'hidden'} flex-col gap-3 mobile-only:hidden`, ref: (el) => (this.popupRef = el), role: "dialog" }, h("div", { class: "truncate text-neutral-dark text-sm" }, this.citation.uri), h(Heading, { level: 0, class: "font-bold text-md" }, this.citation.title), h("p", { class: "text-on-background text-sm" }, this.getTruncatedText())));
    }
    render() {
        var _a;
        return (h("div", { key: '8fb37eb0279374ab1172f72baf1bbdea7612434e', class: "relative" }, h(LinkWithItemAnalytics, { key: '7272e07afc9cdc456bb81705bf121973bf914f66', href: (_a = this.citation.clickUri) !== null && _a !== void 0 ? _a : this.citation.uri, ref: (el) => (this.citationRef = el), part: "citation", target: "_blank", rel: "noopener", "aria-haspopup": "dialog", className: "flex items-center p-1 bg-background btn-outline-primary border rounded-full border-neutral text-on-background", onSelect: () => this.interactiveCitation.select(), onBeginDelayedSelect: () => this.interactiveCitation.beginDelayedSelect(), onCancelPendingSelect: () => this.interactiveCitation.cancelPendingSelect(), stopPropagation: this.stopPropagation, onMouseLeave: this.closePopover, onMouseOver: this.delayedPopoverOpen, onFocus: this.openPopover, onBlur: this.closePopover }, h("div", { key: '0e86544b60faad1b0b59abf17d5b0f05ac6bed8d', part: "citation-index", class: "rounded-full font-medium flex items-center text-bg-primary shrink-0" }, h("div", { key: 'a5bbc6dd192ce5569da83d077bfffaf3bf1d12f9', class: "mx-auto" }, this.index + 1)), h("span", { key: '87cd6d189458d463ef4b503dc3d0c0be87bccc41', class: "citation-title truncate mx-1" }, this.citation.title)), this.renderPopover()));
    }
    get host() { return this; }
    static get watchers() { return {
        "isOpen": ["sendHoverAnalytics"]
    }; }
    static get style() { return AtomicCitationStyle0; }
}, [0, "atomic-citation", {
        "citation": [16],
        "index": [2],
        "sendHoverEndEvent": [16],
        "interactiveCitation": [16],
        "isOpen": [32]
    }, undefined, {
        "isOpen": ["sendHoverAnalytics"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["atomic-citation"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-citation":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicCitation$1);
            }
            break;
    } });
}

const AtomicCitation = AtomicCitation$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicCitation, defineCustomElement };

//# sourceMappingURL=atomic-citation.js.map