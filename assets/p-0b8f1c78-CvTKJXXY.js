import{g as t}from"./atomic-breadbox.new.stories-D03zBEda.js";import{o as l}from"./p-a9dd6559-BMQBvVkk.js";const s=`<svg viewBox="0 0 312 312" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,f=e=>t("span",{class:"font-bold truncate inline-block align-bottom max-w-full whitespace-normal",part:"highlight"},t(l,{key:"between-quotations",params:{text:e.content},bindings:e.bindings})),c=()=>t("atomic-icon",{part:"icon",icon:s,class:"my-6 flex flex-col items-center w-1/2 max-w-lg"}),d=e=>{const{hasQuery:i,query:n}=e.querySummaryState,r=i?t(l,{bindings:e.bindings,key:"no-results-for",params:{query:t(f,{bindings:e.bindings,content:n})}}):e.bindings.i18n.t("no-results");return t("div",{class:"my-2 text-2xl font-medium max-w-full text-center",part:"no-results"},r)},u=e=>t("div",{class:"my-2 text-lg text-neutral-dark text-center",part:"search-tips"},e.bindings.i18n.t("search-tips")),g=(e,i)=>{const n=()=>e.searchStatusState.hasResults?"":e.querySummaryState.hasQuery?e.bindings.i18n.t("no-results-for",{interpolation:{escapeValue:!1},query:e.querySummaryState.query}):e.bindings.i18n.t("no-results");e.setAriaLive(n());const{firstSearchExecuted:r,isLoading:o,hasResults:a}=e.searchStatusState;return!r||o||a?t("span",null):[t("div",{class:"flex flex-col items-center h-full w-full text-on-background"},t(c,null),t(d,{...e}),t(u,{...e}),...i),t("slot",null)]};export{g as a};
