...
import { u as updateQuery2, g as getOrganizationEndpoints, c as buildCommerceEngine, b as buildProductListing, a as buildSearch } from './headless.esm-628c1e39.js';
...
import { D as DEFAULT_MOBILE_BREAKPOINT } from './replace-breakpoint-e74c8165.js';
...
const AtomicCommerceInterface = class {
    ...
    async executeFirstSearch() {
        ...
        this.engine.dispatch(updateQuery2({ query: value }));
        this.engine.executeFirstSearch();
    }
    /**
...
AtomicCommerceInterface.style = atomicCommerceInterfaceCss;

export { AtomicCommerceInterface as atomic_commerce_interface };

//# sourceMappingURL=atomic-commerce-interface.entry.js.map