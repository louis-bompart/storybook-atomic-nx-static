 ...
 */
export interface CommonBindings<Engine extends AnyEngineType, Store extends AtomicCommonStore<AtomicCommonStoreData>, InterfaceElement extends HTMLStencilElement> {
    /**
...
export type AnyBindings = CommonBindings<AnyEngineType, AtomicCommonStore<AtomicCommonStoreData>, HTMLStencilElement>;
