...
const AtomicResultTimespan$1 = /*@__PURE__*/ proxyCustomElement(class AtomicResultTimespan extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        /**
    ...
    get value() {
        return ow.getResultProperty(this.result, this.field);
    }
}, [0, "atomic-result-timespan", {
        "field": [513],
        "unit": [513],
        "format": [513],
        "error": [32]
...
__decorate([
    InitializeBindings()
], AtomicResultTimespan$1.prototype, "bindings", void 0);
__decorate([
    ResultContext()
], AtomicResultTimespan$1.prototype, "result", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-result-timespan", "atomic-component-error"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-result-timespan":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicResultTimespan$1);
            }
            break;
...
const AtomicResultTimespan = AtomicResultTimespan$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicResultTimespan, defineCustomElement };

//# sourceMappingURL=atomic-result-timespan.js.map