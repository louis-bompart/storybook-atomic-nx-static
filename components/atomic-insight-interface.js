...
import { C as CP, b as gW, W as Wa, f as fv } from './headless.esm3.js';
import { i as instance, C as CommonAtomicInterfaceHelper } from './interface-common.js';
import { A as ArrayProp } from './props-utils.js';
import { g as getNextAnalyticsConfig, a as augmentWithExternalMiddleware, b as augmentAnalyticsWithAtomicVersion } from './analytics-config.js';
...
function createAtomicInsightStore() {
...
const AtomicInsightInterface$1 = /*@__PURE__*/ proxyCustomElement(class AtomicInsightInterface extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.store = createAtomicInsightStore();
    ...
    initResultsPerPage() {
        ...
        CP(this.bindings.engine, {
            initialState: { numberOfResults: this.resultsPerPage },
        });
    }
    registerFieldsToInclude() {
        if (this.fieldsToInclude.length) {
            this.engine.dispatch(gW(this.engine).registerFieldsToInclude([
                ...this.fieldsToInclude,
            ]));
        }
    }
    ...
    static get style() { return AtomicInsightInterfaceStyle0; }
}, [1, "atomic-insight-interface", {
        "engine": [1040],
        "analytics": [516],
        "i18n": [16],
        ...
        "resultsPerPage": [514, "results-per-page"],
        "CspNonce": [513, "csp-nonce"],
        "error": [32],
        "getOrganizationEndpoints": [64],
        "initialize": [64],
        "initializeWithInsightEngine": [64],
...
__decorate([
    ArrayProp()
], AtomicInsightInterface$1.prototype, "fieldsToInclude", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-insight-interface"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-insight-interface":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicInsightInterface$1);
            }
            break;
    } });
}

const AtomicInsightInterface = AtomicInsightInterface$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicInsightInterface, defineCustomElement };

//# sourceMappingURL=atomic-insight-interface.js.map