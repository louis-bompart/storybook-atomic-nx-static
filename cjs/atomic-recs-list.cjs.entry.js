...
const AtomicRecsList = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '0ac5de53eede1fd02383f2f5cb0a4be1544a6ba1' }, this.renderHeading(), this.shouldRenderPagination ? (index.h(carousel.Carousel, { bindings: this.bindings, currentPage: this.currentPage, nextPage: () => this.nextPage(), previousPage: () => this.previousPage(), numberOfPages: this.numberOfPages }, this.renderListOfRecommendations())) : (this.renderListOfRecommendations())));
    }
