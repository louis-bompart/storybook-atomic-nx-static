import { getAssetPath, h } from '@stencil/core/internal/client';
import { c as commonjsGlobal, a as commonjsRequire } from './_commonjsHelpers.js';
import { G as Gn } from './headless.esm.js';
...
function loadFocusVisiblePolyfill() {
    ...
    try {
        ...
        // @ts-ignore
        import('./focus-visible.min.js').then(function (n) { return n.f; });
    }
}
...
//# sourceMappingURL=interface-common.js.map