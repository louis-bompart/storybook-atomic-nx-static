...
const AtomicRatingRangeFacet = class {
    ...
    ratingContent(facetValue) {
        return (index.h("div", { class: "flex items-center" }, index.h(atomicRating.Rating, { i18n: this.bindings.i18n, numberOfTotalIcons: this.maxValueInIndex, numberOfActiveIcons: facetValue.start, icon: this.icon }), this.renderLabelText(facetValue)));
    }
    renderHeader() {
    ...
    renderLabelText(facetValue) {
        return (index.h("span", { part: "value-label", class: `ml-1 flex items-center truncate group-focus:text-primary group-hover:text-primary ${facetValue.state === 'selected' ? 'font-bold' : ''}` }, facetValue.start === this.maxValueInIndex ? (index.h("span", null, this.bindings.i18n.t('only'))) : (this.bindings.i18n.t('and-up'))));
    }
...
exports.atomic_rating_range_facet = AtomicRatingRangeFacet;

//# sourceMappingURL=atomic-rating-range-facet.cjs.entry.js.map