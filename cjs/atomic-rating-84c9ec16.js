...
const Rating = (props) => {
    ...
    const renderIcon = (active) => {
        return (index.h("atomic-icon", { icon: props.icon, class: `shrink-0 ${active ? 'icon-active' : 'icon-inactive'}`, style: { width: iconSize, height: iconSize } }));
    };
    ...
    return (index.h("div", { class: "relative w-max", part: "value-rating", role: "img", "aria-label": props.i18n.t('stars', {
        ...
        index.h("div", { class: "absolute left-0 top-0 z-1 flex gap-0.5 overflow-hidden", style: { width } }, filledIconDisplay())));
};
...
//# sourceMappingURL=atomic-rating-84c9ec16.js.map