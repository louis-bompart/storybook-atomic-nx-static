...
const AtomicCitation$1 = /*@__PURE__*/ proxyCustomElement(class AtomicCitation extends HTMLElement {
    ...
    render() {
        var _a;
        return (h("div", { key: 'ea376e005804900590382874bd59f111c89972bb', class: "relative" }, h(LinkWithItemAnalytics, { key: '025ea26023658a62527d52730eec331c91101e01', href: (_a = this.citation.clickUri) !== null && _a !== void 0 ? _a : this.citation.uri, ref: (el) => (this.citationRef = el), part: "citation", target: "_blank", rel: "noopener", "aria-haspopup": "dialog", className: "flex items-center p-1 bg-background btn-outline-primary border rounded-full border-neutral text-on-background", onSelect: () => this.interactiveCitation.select(), onBeginDelayedSelect: () => this.interactiveCitation.beginDelayedSelect(), onCancelPendingSelect: () => this.interactiveCitation.cancelPendingSelect(), stopPropagation: this.stopPropagation, onMouseLeave: this.closePopover, onMouseOver: this.delayedPopoverOpen, onFocus: this.openPopover, onBlur: this.closePopover }, h("div", { key: 'bf1b3229b48023861ede2640564e770698737236', part: "citation-index", class: "rounded-full font-medium flex items-center text-bg-primary shrink-0" }, h("div", { key: '0c42bcf102095bd74e6d73750edeabcb315d5931', class: "mx-auto" }, this.index + 1)), h("span", { key: '47f5d8acf8cbc1c1ff0762839232103b98a8e1bd', class: "citation-title truncate mx-1" }, this.citation.title)), this.renderPopover()));
    }
