...
import { W as WF } from './headless.esm2.js';
...
import { d as defineCustomElement$d } from './atomic-product2.js';
...
const AtomicCommerceRecommendationList$1 = /*@__PURE__*/ proxyCustomElement(class AtomicCommerceRecommendationList extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    initialize() {
        ...
        this.validateSlotID();
        this.recommendations = WF(this.bindings.engine, {
            options: {
                slotId: this.slotId,
            },
        });
    ...
    renderHeading() {
        ...
        return (h(Heading, { level: this.headingLevel, part: "label", class: "m-0 mb-2" }, this.bindings.i18n.t(this.recommendationsState.headline)));
    }
    get currentIndex() {
    ...
    computeListDisplayClasses() {
        ...
        return getItemListDisplayClasses('grid', this.density, this.imageSize, this.recommendationsState.isLoading, displayPlaceholders);
    }
    renderAsGrid(product, i) {
        var _a;
        const atomicProductProps = this.getAtomicProductProps(product);
        return (h(DisplayGrid, { item: {
                ...product,
                clickUri: product.clickUri,
                title: (_a = product.ec_name) !== null && _a !== void 0 ? _a : '',
            }, ...atomicProductProps.interactiveProduct, setRef: (element) => element && this.itemListCommon.setNewResultRef(element, i) }, h("atomic-product", { ...atomicProductProps })));
    }
    renderRecommendationList() {
        ...
        return (h(DisplayWrapper, { listClasses: listClasses, display: "grid" }, h(ResultsPlaceholdersGuard, { density: this.density, display: this.display, imageSize: this.imageSize, displayPlaceholders: !this.bindings.store.isAppLoaded(), numberOfPlaceholders: (_a = this.productsPerPage) !== null && _a !== void 0 ? _a : this.recommendationsState.products.length }), h(ItemDisplayGuard, { ...this.augmentedRecommendationListState }, this.subsetRecommendations.map((recommendation, i) => {
    ...
    static get style() { return AtomicCommerceRecommendationListStyle0; }
}, [1, "atomic-commerce-recommendation-list", {
        "slotId": [513, "slot-id"],
        "display": [513],
        "gridCellLinkTarget": [1, "grid-cell-link-target"],
        "density": [513],
        "imageSize": [513, "image-size"],
        "productsPerPage": [514, "products-per-page"],
        "headingLevel": [514, "heading-level"],
        "recommendationsState": [32],
        "error": [32],
        "productTemplateRegistered": [32],
        "templateHasError": [32],
        "currentPage": [32],
...
__decorate([
    InitializeBindings()
], AtomicCommerceRecommendationList$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('recommendations')
], AtomicCommerceRecommendationList$1.prototype, "recommendationsState", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-commerce-recommendation-list", "atomic-component-error", "atomic-icon", "atomic-product", "atomic-result-link", "atomic-result-placeholder", "atomic-result-section-actions", "atomic-result-section-badges", "atomic-result-section-bottom-metadata", "atomic-result-section-excerpt", "atomic-result-section-title", "atomic-result-section-visual", "atomic-result-table-placeholder", "atomic-result-text", "atomic-text"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-commerce-recommendation-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicCommerceRecommendationList$1);
            }
            break;
...
const AtomicCommerceRecommendationList = AtomicCommerceRecommendationList$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicCommerceRecommendationList, defineCustomElement };

//# sourceMappingURL=atomic-commerce-recommendation-list.js.map