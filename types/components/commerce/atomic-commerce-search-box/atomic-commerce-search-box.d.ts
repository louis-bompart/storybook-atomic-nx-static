import { StandaloneSearchBox, SearchBox } from '@coveo/headless/commerce';
 ...
 * @internal
 */
export declare class AtomicCommerceSearchBox implements InitializableComponent<Bindings> {
    bindings: Bindings;
    private searchBox;
