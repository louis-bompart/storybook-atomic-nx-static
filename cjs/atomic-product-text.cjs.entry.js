...
function getStringValueFromProductOrNull(product, field) {
    const value = headless_esm.VA.getProductProperty(product, field);
...
const AtomicProductText = class {
    ...
    possiblyWarnOnBadFieldType() {
        const productValueRaw = headless_esm.VA.getProductProperty(this.product, this.field);
    ...
    render() {
        ...
        if (!productValueAsString && this.default) {
            this.possiblyWarnOnBadFieldType();
            return (index.h("atomic-commerce-text", { value: fieldUtils.getFieldValueCaption(this.field, productValueAsString !== null && productValueAsString !== void 0 ? productValueAsString : this.default, this.bindings.i18n) }));
        }
        if (productValueAsString !== null) {
            this.possiblyWarnOnBadFieldType();
            return (index.h("atomic-commerce-text", { value: fieldUtils.getFieldValueCaption(this.field, productValueAsString, this.bindings.i18n) }));
        }
    }
...
//# sourceMappingURL=atomic-product-text.cjs.entry.js.map