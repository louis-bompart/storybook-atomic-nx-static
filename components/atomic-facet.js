...
import { j as jE, K as KO, _ as _T } from './headless.esm.js';
...
import { s as shouldUpdateFacetSearchComponent, a as shouldDisplaySearchResults } from './facet-value-label-highlight.js';
...
const AtomicFacetStyle0 = atomicFacetCss;
...
const AtomicFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    initConditionManager() {
        this.facetConditionsManager = _T(this.bindings.engine, {
            facetId: this.facetId,
    ...
    static get style() { return AtomicFacetStyle0; }
}, [1, "atomic-facet", {
...
__decorate([
    InitializeBindings()
], AtomicFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facet')
], AtomicFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    MapProp()
], AtomicFacet$1.prototype, "dependsOn", void 0);
__decorate([
    ArrayProp()
], AtomicFacet$1.prototype, "allowedValues", void 0);
__decorate([
    ArrayProp()
], AtomicFacet$1.prototype, "customSort", void 0);
__decorate([
    AriaLiveRegion('facet-search')
], AtomicFacet$1.prototype, "facetSearchAriaMessage", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-facet", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicFacet$1);
            }
            break;
...
const AtomicFacet = AtomicFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicFacet, defineCustomElement };

//# sourceMappingURL=atomic-facet.js.map