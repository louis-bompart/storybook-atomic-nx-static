...
import { f as fA } from './headless.esm2.js';
...
const AtomicCommerceSearchBoxRecentQueries = /*@__PURE__*/ proxyCustomElement(class AtomicCommerceSearchBoxRecentQueries extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "atomic-commerce-search-box-recent-queries", {
        "icon": [1],
...
function defineCustomElement() {
    ...
    const components = ["atomic-commerce-search-box-recent-queries", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-commerce-search-box-recent-queries":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicCommerceSearchBoxRecentQueries);
            }
            break;
...
export { AtomicCommerceSearchBoxRecentQueries as A, defineCustomElement as d };

//# sourceMappingURL=atomic-commerce-search-box-recent-queries2.js.map