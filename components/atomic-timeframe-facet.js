...
import { _ as _T, l as lo, U as OP, K as KO, Y as YE, V as cI, $ as wfe } from './headless.esm.js';
...
const AtomicTimeframeFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicTimeframeFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    initialize() {
        this.timeframeFacetCommon = new TimeframeFacetCommon({
            ...
            buildDependenciesManager: () => {
                var _a, _b;
                return _T(this.bindings.engine, {
    ...
    initializeFacetForDatePicker() {
        this.facetForDatePicker = YE(this.bindings.engine, {
            options: {
    ...
    initializeFacetForDateRange(values) {
        this.facetForDateRange = YE(this.bindings.engine, {
            options: {
                facetId: this.facetId,
                field: this.field,
    ...
    initializeFilter() {
        this.filter = cI(this.bindings.engine, {
            options: {
    ...
    applyDateInput() {
        this.facetId &&
            this.bindings.engine.dispatch(wfe(this.bindings.engine).deselectAllDateFacetValues(this.facetId));
    }
    render() {
    ...
    static get style() { return AtomicTimeframeFacetStyle0; }
}, [1, "atomic-timeframe-facet", {
...
__decorate([
    InitializeBindings()
], AtomicTimeframeFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facetForDateRange')
], AtomicTimeframeFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('facetForDatePicker')
], AtomicTimeframeFacet$1.prototype, "facetForDatePickerState", void 0);
__decorate([
    BindStateToController('filter')
], AtomicTimeframeFacet$1.prototype, "filterState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicTimeframeFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    MapProp()
], AtomicTimeframeFacet$1.prototype, "dependsOn", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-timeframe-facet", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-timeframe-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicTimeframeFacet$1);
            }
            break;
...
const AtomicTimeframeFacet = AtomicTimeframeFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicTimeframeFacet, defineCustomElement };

//# sourceMappingURL=atomic-timeframe-facet.js.map