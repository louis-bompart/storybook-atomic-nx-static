...
const SmartSnippetFeedbackBanner = (props) => {
    ...
    const Buttons = () => (index.h("div", { part: "feedback-buttons", class: "flex gap-x-4" },
        index.h("label", { part: "feedback-like-button", class: 'flex items-center gap-x-1.5 ' +
            ...
            index.h(radioButton.RadioButton, { groupName: radioGroupName, text: props.i18n.t('yes'), checked: props.liked, onChecked: () => props.onLike(), class: "text-inherit cursor-inherit" })),
        index.h("label", { part: "feedback-dislike-button", class: 'flex items-center gap-x-1.5 ' +
            ...
            index.h(radioButton.RadioButton, { groupName: radioGroupName, text: props.i18n.t('no'), checked: props.disliked, onChecked: () => props.onDislike(), class: "text-inherit cursor-inherit" }))));
    ...
    const ExplainWhyButton = () => (index.h(button.Button, { part: "feedback-explain-why-button", style: "text-primary", onClick: () => props.onPressExplainWhy(), ref: (element) => { var _a; return (_a = props.explainWhyRef) === null || _a === void 0 ? void 0 : _a.call(props, element); } }, props.i18n.t('smart-snippet-feedback-explain-why')));
...
class SmartSnippetCommon {
    ...
    renderQuestion() {
        ...
        return (index.h(heading.Heading, { level: headingLevel ? headingLevel + 1 : 0, class: "text-xl font-bold", part: "question" }, this.props.getSmartSnippetState().question));
    }
    canSnippetCollapse() {
        var _a, _b;
    ...
    renderContent() {
        ...
        if (this.canSnippetCollapse()) {
            return (index.h("div", { part: "truncated-answer" },
                index.h("atomic-smart-snippet-answer", { exportparts: "answer", part: "body", htmlContent: state.answer, innerStyle: this.style })));
        }
        return (index.h("atomic-smart-snippet-expandable-answer", { exportparts: "answer,show-more-button,show-less-button,truncated-answer", part: "body", htmlContent: state.answer, expanded: state.expanded, maximumHeight: this.props.getMaximumHeight(), collapsedHeight: this.props.getCollapsedHeight(), snippetStyle: this.style, onExpand: () => this.props.getSmartSnippet().expand(), onCollapse: () => this.props.getSmartSnippet().collapse() }));
    }
    renderFeedbackBanner() {
        const state = this.props.getSmartSnippetState();
        return (index.h(SmartSnippetFeedbackBanner, { i18n: this.props.getBindings().i18n, id: this.props.id, liked: state.liked, disliked: state.disliked, feedbackSent: this.props.getFeedbackSent(), onLike: () => this.props.getSmartSnippet().like(), onDislike: () => {
                this.loadModal();
    ...
    render() {
        ...
        return (index.h("aside", null,
            index.h(heading.Heading, { level: (_a = this.props.getHeadingLevel()) !== null && _a !== void 0 ? _a : 0, class: "accessibility-only" }, this.props.getBindings().i18n.t('smart-snippet')),
            index.h("article", { class: "bg-background border border-neutral rounded-lg p-6 pb-4 text-on-background", part: "smart-snippet" },
                index.h("atomic-smart-snippet-collapse-wrapper", { maximumHeight: (_c = (_b = this.props).getSnippetMaximumHeight) === null || _c === void 0 ? void 0 : _c.call(_b), collapsedHeight: (_e = (_d = this.props).getSnippetCollapsedHeight) === null || _e === void 0 ? void 0 : _e.call(_d) },
                    this.renderQuestion(),
                    this.renderContent(),
                    index.h("footer", { part: "footer", "aria-label": this.props
                            .getBindings()
                            .i18n.t('smart-snippet-source') },
                        source && (index.h("atomic-smart-snippet-source", { anchorAttributes: (_g = (_f = this.props).getSourceAnchorAttributes) === null || _g === void 0 ? void 0 : _g.call(_f), source: source, onSelectSource: this.props.getSmartSnippet().selectSource, onBeginDelayedSelectSource: this.props.getSmartSnippet().beginDelayedSelectSource, onCancelPendingSelectSource: this.props.getSmartSnippet().cancelPendingSelectSource })),
                        this.renderFeedbackBanner())))));
    }
}

exports.SmartSnippetCommon = SmartSnippetCommon;

//# sourceMappingURL=smart-snippet-common-407da91f.js.map