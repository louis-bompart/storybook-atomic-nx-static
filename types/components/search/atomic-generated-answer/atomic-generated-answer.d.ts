import { SearchStatus, GeneratedAnswer, GeneratedAnswerState, GeneratedAnswerStyle } from '@coveo/headless';
 ...
 */
export declare class AtomicGeneratedAnswer implements InitializableComponent {
    bindings: Bindings;
    ...
    initialize(): void;
    updateAnswerCollapsed(newState: GeneratedAnswerState, oldState: GeneratedAnswerState): void;
