...
function AriaLiveRegion(regionName, assertive = false) {
    function getAriaLiveElement() {
        const event = eventUtils.buildCustomEvent(findAriaLiveEventName, {});
...
exports.FocusTargetController = FocusTargetController;
exports.getFirstFocusableDescendant = getFirstFocusableDescendant;

//# sourceMappingURL=accessibility-utils-8ec8aa46.js.map