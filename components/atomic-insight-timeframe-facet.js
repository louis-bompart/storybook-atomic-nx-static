...
import { M as MP, S as Sa, t as tb, I as IP, Q as Qw, H as Hw, E as Ez } from './headless.esm3.js';
...
const AtomicInsightTimeframeFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicInsightTimeframeFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    initialize() {
        this.timeframeFacetCommon = new TimeframeFacetCommon({
            ...
            buildDependenciesManager: () => {
                var _a, _b;
                return MP(this.bindings.engine, {
                    facetId: (_b = (_a = this.facetForDateRange) === null || _a === void 0 ? void 0 : _a.state.facetId) !== null && _b !== void 0 ? _b : this.filter.state.facetId,
                    conditions: parseDependsOn(this.dependsOn),
                });
            },
            buildDateRange: Sa,
            getSearchStatusState: () => this.searchStatusState,
            deserializeRelativeDate: tb,
    ...
    disconnectedCallback() {
        var _a;
        (_a = this.timeframeFacetCommon) === null || _a === void 0 ? void 0 : _a.disconnectedCallback();
    }
    initializeFacetForDatePicker() {
        this.facetForDatePicker = Qw(this.bindings.engine, {
            options: {
    ...
    initializeFacetForDateRange(values) {
        this.facetForDateRange = Qw(this.bindings.engine, {
            options: {
                facetId: this.facetId,
                field: this.field,
    ...
    initializeFilter() {
        this.filter = Hw(this.bindings.engine, {
            options: {
    ...
    applyDateInput() {
        this.facetId &&
            this.bindings.engine.dispatch(Ez(this.bindings.engine).deselectAllDateFacetValues(this.facetId));
    }
    render() {
    ...
    static get style() { return AtomicInsightTimeframeFacetStyle0; }
}, [1, "atomic-insight-timeframe-facet", {
        "facetId": [1537, "facet-id"],
        "label": [513],
        "field": [513],
        "withDatePicker": [516, "with-date-picker"],
        ...
        "facetState": [32],
        "facetForDatePickerState": [32],
        "filterState": [32],
        "searchStatusState": [32],
        "error": [32]
    }, [[0, "atomic/dateInputApply", "applyDateInput"]]]);
__decorate([
    InitializeBindings()
], AtomicInsightTimeframeFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facetForDateRange')
], AtomicInsightTimeframeFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('facetForDatePicker')
], AtomicInsightTimeframeFacet$1.prototype, "facetForDatePickerState", void 0);
__decorate([
    BindStateToController('filter')
], AtomicInsightTimeframeFacet$1.prototype, "filterState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicInsightTimeframeFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    MapProp()
], AtomicInsightTimeframeFacet$1.prototype, "dependsOn", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-insight-timeframe-facet", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-insight-timeframe-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicInsightTimeframeFacet$1);
            }
            break;
...
const AtomicInsightTimeframeFacet = AtomicInsightTimeframeFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicInsightTimeframeFacet, defineCustomElement };

//# sourceMappingURL=atomic-insight-timeframe-facet.js.map