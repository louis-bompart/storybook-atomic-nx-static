...
const CopyButton = (props) => {
    return (h(Button, { title: props.title, part: "copy-button", style: 'text-transparent', class: `p-2 rounded-md ${props.isCopied ? 'copied' : ''} ${props.error ? 'error' : ''}`, onClick: props.onClick },
...
const FeedbackButton = (props) => {
    return (h(Button, { title: props.title, style: "text-transparent", part: "feedback-button", class: `feedback-button p-2 rounded-md ${props.variant} ${props.active ? 'active' : ''}`, onClick: props.onClick, ariaPressed: `${props.active}` },
        h("atomic-icon", { class: "w-5", icon: Thumbs })));
};

var marked_umd$1 = {exports: {}};
...
}(marked_umd$1, marked_umd$1.exports));

const marked_umd = marked_umd$1.exports;
...
const transformMarkdownToHtml = (text) => {
    return marked_umd$1.exports.marked.use({ renderer: customRenderer }).parse(text);
};

const GeneratedMarkdownContent = (props) => {
    var _a;
    const answerAsHtml = DOMPurify.sanitize(transformMarkdownToHtml((_a = props.answer) !== null && _a !== void 0 ? _a : ''), { ADD_ATTR: ['part'] });
    return (h("div", { part: "generated-text", class: `mb-0 text-on-background ${props.isStreaming ? 'cursor' : ''}`, innerHTML: answerAsHtml }));
};

const GeneratedTextContent = (props) => {
    return (h("p", { part: "generated-text", class: `mb-0 text-on-background whitespace-pre-wrap ${props.isStreaming ? 'cursor' : ''}` }, props.answer));
};
...
const RephraseButtons = (props) => {
    const { i18n } = props;
    return (h("div", { part: "rephrase-buttons", class: "shrink-0" },
        h("p", { part: "rephrase-label", class: "mb-2 text-neutral-dark shrink-0" }, i18n.t('rephrase')),
        h("div", { part: "rephrase-buttons-container", class: "flex flex-wrap gap-2 ml-auto border border-solid rounded-md p-1" }, options.map((option) => {
            const isActive = props.answerStyle === option.value;
            return (h(Button, { title: i18n.t(option.tooltipKey), part: "rephrase-button", style: "text-transparent", class: `flex items-center rounded ${isActive ? 'active' : ''}`, onClick: () => {
                    props.onChange(option.value);
                }, ariaPressed: String(isActive) },
                h("div", { class: "icon-container text-neutral-dark h-full mx-auto shrink-0 relative" },
                    h("atomic-icon", { icon: option.icon })),
                h("div", { part: "rephrase-button-label", class: "hidden text-neutral-dark" }, i18n.t(option.titleKey))));
        }))));
};

const RetryPrompt = (props) => (h("div", { part: "retry-container", class: "mt-4" },
    h("div", { class: "mx-auto text-center text-neutral-dark" }, props.message),
    h(Button, { class: "block px-4 py-2 mt-4 mx-auto", style: "outline-primary", onClick: props.onClick }, props.buttonLabel)));
...
const ShowButton = (props) => (h(Button, { style: "text-primary", part: "answer-show-button", class: "hidden items-center hover:bg-transparent", onClick: () => props.onClick() },
    h("div", { class: "font-light text-base" }, props.isCollapsed
        ? props.i18n.t('show-more')
        : props.i18n.t('show-less')),
    h("atomic-icon", { part: "answer-show-icon", class: "w-3.5 ml-2", icon: props.isCollapsed ? ArrowBottomIcon : ArrowUp })));

const SourceCitations = (props, children) => props.isVisible ? (h("div", { class: "source-citations" },
    h("p", { part: "citations-label", class: "mb-2 text-neutral-dark shrink-0" }, props.label),
    h("ol", { class: "list-none citations-container gap-2 flex items-center flex-wrap" }, children))) : null;
...
class GeneratedAnswerCommon {
    ...
    renderCitations() {
        ...
        return citations === null || citations === void 0 ? void 0 : citations.map((citation, index) => {
    ...
    renderFeedbackAndCopyButtons() {
        ...
        return (h("div", { class: containerClasses },
            h(FeedbackButton, { title: i18n.t('this-answer-was-helpful'), variant: "like", active: !!liked, onClick: () => { var _a; return (_a = getGeneratedAnswer()) === null || _a === void 0 ? void 0 : _a.like(); } }),
    ...
    renderRephraseButtons() {
        ...
        return (h(RephraseButtons, { answerStyle: answerStyle !== null && answerStyle !== void 0 ? answerStyle : 'default', i18n: i18n, onChange: (answerStyle) => this.onChangeAnswerStyle(answerStyle) }));
    }
    renderDisclaimer() {
        var _a;
        const { getGeneratedAnswerState, getBindings } = this.props;
        ...
        return (h("div", { class: "text-neutral-dark text-xs" },
    ...
    renderGeneratingAnswerLabel() {
        ...
        return (h("div", { part: "is-generating", class: "hidden text-primary font-light text-base" },
    ...
    renderContent() {
        ...
        return (h("div", { part: "generated-content" },
            h("div", { class: "flex items-center" },
                h(Heading, { level: 0, part: "header-label", class: "text-bg-primary font-medium inline-block rounded-md py-2 px-2.5" }, i18n.t('generated-answer-title')),
                h("div", { class: "flex h-9 items-center ml-auto" },
            ...
            this.hasRetryableError && this.isAnswerVisible ? (h(RetryPrompt, { onClick: () => { var _a; return (_a = getGeneratedAnswer()) === null || _a === void 0 ? void 0 : _a.retry(); }, buttonLabel: i18n.t('retry'), message: i18n.t('retry-stream-message') })) : null,
            !this.hasRetryableError && this.isAnswerVisible ? (h(GeneratedContentContainer, { answer: answer, answerContentFormat: answerContentFormat, isStreaming: !!isStreaming },
                ...
                h(SourceCitations, { label: i18n.t('citations'), isVisible: !!(citations === null || citations === void 0 ? void 0 : citations.length) }, this.renderCitations()),
                this.renderRephraseButtons())) : null,
            !this.hasRetryableError && this.isAnswerVisible && (h("div", { part: "generated-answer-footer", class: "flex justify-end mt-6" },
    ...
    render() {
        ...
        return (h("div", null,
            h("aside", { class: `mx-auto ${this.contentClasses}`, part: "container" },
                h("article", null, this.renderContent()))));
    }
}

export { GeneratedAnswerCommon as G };

//# sourceMappingURL=generated-answer-common-a12cd734.js.map