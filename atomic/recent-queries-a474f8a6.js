import { Y as highlight_exports } from './headless.esm-bdb53e72.js';
...
const RecentQueryText = ({ query, value, }) => {
    ...
    return (h("span", { part: "recent-query-text", class: "break-all line-clamp-2", innerHTML: highlight_exports.highlightString({
            content: value,
...
export { RecentQueryClear as R, getPartialRecentQueryElement as a, RecentQueriesContainer as b, RecentQueryIcon as c, RecentQueryText as d, getPartialRecentQueryClearElement as g };

//# sourceMappingURL=recent-queries-a474f8a6.js.map