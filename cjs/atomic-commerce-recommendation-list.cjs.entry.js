...
const AtomicCommerceRecommendationList = class {
    ...
    render() {
        return (index.h(index.Fragment, { key: '1edf95fbd7f7e6717305f3b072ec8be6f17b89aa' }, this.renderHeading(), this.shouldRenderPagination ? (index.h(carousel.Carousel, { bindings: this.bindings, currentPage: this.currentPage, nextPage: () => this.nextPage(), previousPage: () => this.previousPage(), numberOfPages: this.numberOfPages }, this.renderRecommendationList())) : (this.renderRecommendationList())));
    }
