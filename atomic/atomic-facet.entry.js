import { r as registerInstance, h, F as Fragment, g as getElement } from './index-53978573.js';
import { g as buildFacet, d as buildSearchStatus, f as buildCoreFacetConditionsManager } from './headless.esm-bdb53e72.js';
...
import { F as FacetSearchInput, c as FacetShowMoreLess, b as FacetSearchMatches, a as announceFacetSearchResultsWithAriaLive } from './facet-show-more-less-172398b5.js';
import { F as FacetSearchInputGuard, a as FacetSearchValue, b as FacetValue } from './facet-search-value-1ba9aedc.js';
import { s as shouldUpdateFacetSearchComponent, a as shouldDisplaySearchResults } from './facet-value-label-highlight-9ee13cbe.js';
...
import './facet-value-box-a73e967d.js';
...
const AtomicFacet = class {
    ...
    componentShouldUpdate(next, prev, propName) {
        if (this.isFacetState(prev, propName) &&
    ...
    renderBody() {
        ...
        return (h(Fragment, null, h(FacetSearchInputGuard, { canShowMoreValues: this.facetState.canShowMoreValues, numberOfDisplayedValues: this.facetState.values.length, withSearch: this.withSearch }, h(FacetSearchInput, { i18n: this.bindings.i18n, label: this.definedLabel, onChange: (value) => {
                if (value === '') {
    ...
    renderSearchResults() {
        return this.renderValuesContainer(this.facet.state.facetSearch.values.map((value) => (h(FacetSearchValue, { ...this.facetValueProps, facetCount: value.count, onExclude: () => this.facet.facetSearch.exclude(value), onSelect: () => this.displayValuesAs === 'link'
                ? this.facet.facetSearch.singleSelect(value)
                : this.facet.facetSearch.select(value), facetValue: value.rawValue }))));
    }
    renderValues() {
        return this.renderValuesContainer(this.facet.state.values.map((value, i) => {
            ...
            return (h(FacetValue, { ...this.facetValueProps, facetCount: value.numberOfResults, onExclude: () => this.facet.toggleExclude(value), onSelect: () => this.displayValuesAs === 'link'
                    ? this.facet.toggleSingleSelect(value)
                    : this.facet.toggleSelect(value), facetValue: value.value, facetState: value.state, setRef: (btn) => {
                    var _a, _b;
    ...
    initConditionManager() {
        this.facetConditionsManager = buildCoreFacetConditionsManager(this.bindings.engine, {
            facetId: this.facetId,
    ...
    get definedLabel() {
        var _a;
        return this.label === 'no-label' && ((_a = this.facetState) === null || _a === void 0 ? void 0 : _a.label)
...
], AtomicFacet.prototype, "facetSearchAriaMessage", void 0);
AtomicFacet.style = atomicFacetCss;

export { AtomicFacet as atomic_facet };

//# sourceMappingURL=atomic-facet.entry.js.map