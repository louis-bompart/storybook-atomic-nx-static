...
const AtomicFoldedResultList = class {
    ...
    render() {
        ...
        return (h(ItemListGuard, { key: '377ae17d94b9df97a9b26e7e36b940a95083361d', hasError: this.foldedResultListState.hasError, firstRequestExecuted: this.foldedResultListState.firstSearchExecuted, hasItems: this.foldedResultListState.hasResults, hasTemplate: this.resultTemplateRegistered, templateHasError: this.itemTemplateProvider.hasError }, h(DisplayWrapper, { key: 'f126cab07b64c6e6a81be6c253034ead28cbdac8', listClasses: listClasses, display: this.display }, h(ResultsPlaceholdersGuard, { key: '70d951456239b3045ee6073223249bd2ecc94cc7', density: this.density, imageSize: this.imageSize, display: this.display, displayPlaceholders: !this.bindings.store.isAppLoaded(), numberOfPlaceholders: this.resultsPerPageState.numberOfResults }), h(ItemDisplayGuard, { key: '2db66d58267c68626b29eddcb368ba91516aab28', firstRequestExecuted: this.foldedResultListState.firstSearchExecuted, hasItems: this.foldedResultListState.hasResults }, this.foldedResultListState.results.map((collection, i) => {
