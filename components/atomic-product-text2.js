...
import { d as defineCustomElement$2 } from './atomic-commerce-text2.js';
...
function getStringValueFromProductOrNull(product, field) {
    const value = VA.getProductProperty(product, field);
...
const AtomicProductText = /*@__PURE__*/ proxyCustomElement(class AtomicProductText extends HTMLElement {
    ...
    possiblyWarnOnBadFieldType() {
        const productValueRaw = VA.getProductProperty(this.product, this.field);
        if (lodash.exports.isArray(productValueRaw)) {
...
function defineCustomElement() {
    ...
    const components = ["atomic-product-text", "atomic-commerce-text", "atomic-component-error"];
