...
const jsxUtils = require('./jsx-utils-746deda4.js');

const MagnifyingGlassIcon = `<svg viewBox="0 0 312 312" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const BetweenQuotes = (props) => {
    return (index.h("span", { class: "font-bold truncate inline-block align-bottom max-w-full whitespace-normal", part: "highlight" },
        index.h(jsxUtils.LocalizedString, { key: "between-quotations", params: { text: props.content }, bindings: props.bindings })));
};
const MagnifyingGlass = () => (index.h("atomic-icon", { part: "icon", icon: MagnifyingGlassIcon, class: "my-6 flex flex-col items-center w-1/2 max-w-lg" }));
const NoResults = (props) => {
    const { hasQuery, query } = props.querySummaryState;
    const content = hasQuery ? (index.h(jsxUtils.LocalizedString, { bindings: props.bindings, key: "no-results-for", params: {
            query: index.h(BetweenQuotes, { bindings: props.bindings, content: query }),
        } })) : (props.bindings.i18n.t('no-results'));
    return (index.h("div", { class: "my-2 text-2xl font-medium max-w-full text-center", part: "no-results" }, content));
};
const SearchTips = (props) => {
    return (index.h("div", { class: "my-2 text-lg text-neutral-dark text-center", part: "search-tips" }, props.bindings.i18n.t('search-tips')));
};
const NoResultsCommon = (props, children) => {
    const getSummary = () => {
    ...
    return [
        index.h("div", { class: "flex flex-col items-center h-full w-full text-on-background" },
            index.h(MagnifyingGlass, null),
            index.h(NoResults, { ...props }),
            index.h(SearchTips, { ...props }),
            ...children),
        index.h("slot", null),
    ];
};

exports.NoResultsCommon = NoResultsCommon;

//# sourceMappingURL=no-results-common-0374ca49.js.map