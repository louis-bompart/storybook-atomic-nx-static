...
const AtomicNumericFacet = class {
    ...
    initializeFacetForInput() {
        ...
        this.facetForInput = headless_esm.eI(this.bindings.engine, {
            options: {
                numberOfValues: 1,
    ...
    initializeFacetForRange() {
        ...
        this.manualRanges = Array.from(this.host.querySelectorAll('atomic-numeric-range')).map(({ start, end, endInclusive, label }) => ({
            ...headless_esm.xs({ start, end, endInclusive }),
            label,
        }));
        this.facetForRange = headless_esm.eI(this.bindings.engine, {
            options: {
    ...
    initializeFilter() {
        ...
        this.filter = headless_esm.oI(this.bindings.engine, {
            options: {
    ...
    render() {
        ...
        return (index.h(facetGuard.FacetGuard, { key: '81b2041548b541c50346f5ccfbe2db28d0b4cf1b', enabled: this.enabled, firstSearchExecuted: firstSearchExecuted, hasError: hasError, hasResults: this.shouldRenderFacet }, firstSearchExecuted ? (index.h(facetPlaceholder.FacetContainer, null, index.h(facetPlaceholder.FacetHeader, { i18n: i18n, label: this.label, onClearFilters: () => {
            ...
            this.shouldRenderInput && (index.h("atomic-facet-number-input", { type: this.withInput, bindings: this.bindings, label: this.label, filter: this.filter, filterState: this.filter.state })),
    ...
    renderValues() {
        ...
        return (index.h(valuesContainer.NumericFacetValuesContainer, { i18n: i18n, label: label }, this.valuesToRender.map((value) => (index.h(valuesContainer.NumericFacetValueLink, { formatter: formatter, displayValuesAs: displayValuesAs, facetValue: value, field: field, i18n: i18n, logger: logger, manualRanges: manualRanges, onClick: () => this.displayValuesAs === 'link'
...
AtomicNumericFacet.style = AtomicNumericFacetStyle0;

exports.atomic_numeric_facet = AtomicNumericFacet;

//# sourceMappingURL=atomic-numeric-facet.cjs.entry.js.map