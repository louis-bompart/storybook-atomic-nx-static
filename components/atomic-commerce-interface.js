...
import { M as Mt, N as No, S as Sv, z as zF, Z as ZF } from './headless.esm2.js';
...
import { d as defineCustomElement$2 } from './atomic-aria-live2.js';
...
const AtomicCommerceInterface$1 = /*@__PURE__*/ proxyCustomElement(class AtomicCommerceInterface extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    async executeFirstSearch() {
        ...
        this.engine.dispatch(Mt({ query: value }));
        this.engine.executeFirstSearch();
    }
    /**
    ...
    initSearchStatus() {
        if (this.type === 'product-listing') {
            this.searchStatus = zF(this.engine);
        }
    ...
    static get style() { return AtomicCommerceInterfaceStyle0; }
}, [1, "atomic-commerce-interface", {
        "type": [1537],
        "analytics": [516],
        ...
        "error": [32],
        "initialize": [64],
        "initializeWithEngine": [64],
        "executeFirstSearch": [64],
        "getOrganizationEndpoints": [64]
    }, [[0, "atomic/initializeComponent", "handleInitialization"], [0, "atomic/scrollToTop", "scrollToTop"]], {
        "analytics": ["toggleAnalytics"],
        "language": ["updateLanguage"],
        "iconAssetsPath": ["updateIconAssetsPath"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["atomic-commerce-interface", "atomic-aria-live"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-commerce-interface":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicCommerceInterface$1);
            }
            break;
...
const AtomicCommerceInterface = AtomicCommerceInterface$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicCommerceInterface, defineCustomElement };

//# sourceMappingURL=atomic-commerce-interface.js.map