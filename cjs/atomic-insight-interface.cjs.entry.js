...
function getAnalyticsConfig(searchEngineConfig, enabled) {
    ...
    switch ((_a = searchEngineConfig.analytics) === null || _a === void 0 ? void 0 : _a.analyticsMode) {
        case 'next':
            return analyticsConfig.getNextAnalyticsConfig(searchEngineConfig, enabled);
        case 'legacy':
        default:
...
function augmentAnalytics(event, payload, config) {
    let result = analyticsConfig.augmentWithExternalMiddleware(event, payload, config);
...
const AtomicInsightInterface = class {
    constructor(hostRef) {
        ...
        this.commonInterfaceHelper = new interfaceCommon.CommonAtomicInterfaceHelper(this, 'CoveoAtomic');
    }
    connectedCallback() {
    ...
    initResultsPerPage() {
        ...
        headless_esm.CP(this.bindings.engine, {
            initialState: { numberOfResults: this.resultsPerPage },
        });
    }
    registerFieldsToInclude() {
        if (this.fieldsToInclude.length) {
            this.engine.dispatch(headless_esm.gW(this.engine).registerFieldsToInclude([
                ...this.fieldsToInclude,
            ]));
        }
    }
    ...
    async getOrganizationEndpoints(organizationId, env = 'prod') {
        return headless_esm.Wa(organizationId, env);
    }
    /**
...
AtomicInsightInterface.style = AtomicInsightInterfaceStyle0;

exports.atomic_insight_interface = AtomicInsightInterface;

//# sourceMappingURL=atomic-insight-interface.cjs.entry.js.map