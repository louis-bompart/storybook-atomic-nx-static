import { w as wk, o as ow } from './headless.esm-88bad35d.js';
...
function bindLogDocumentOpenOnResult(engine, result, resultElement, selector) {
    const interactiveResult = wk(engine, {
        options: { result },
    });
    const eventsMap = {
...
function getStringValueFromResultOrNull(result, field) {
    const value = ow.getResultProperty(result, field);
...
//# sourceMappingURL=result-utils-a899cfd0.js.map