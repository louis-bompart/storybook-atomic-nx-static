...
const AtomicText = /*@__PURE__*/ proxyCustomElement(class AtomicText extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement() {
    ...
    const components = ["atomic-text", "atomic-component-error"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-text":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicText);
            }
            break;
...
export { AtomicText as A, defineCustomElement as d };

//# sourceMappingURL=atomic-text2.js.map