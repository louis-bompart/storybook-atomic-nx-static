...
import { d as buildSearchStatus, v as buildNumericFacet, f as buildCoreFacetConditionsManager, w as buildNumericRange } from './headless.esm-bdb53e72.js';
import { S as Star, R as Rating } from './atomic-rating-47afcd88.js';
...
const AtomicRatingFacet = class {
    ...
    generateCurrentValues() {
        ...
        for (let i = this.minValueInIndex; i <= this.numberOfIntervals; i++) {
            currentValues.push(buildNumericRange({
...
__decorate([
    InitializeBindings()
], AtomicRatingFacet.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facet')
], AtomicRatingFacet.prototype, "facetState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicRatingFacet.prototype, "searchStatusState", void 0);
__decorate([
    MapProp()
], AtomicRatingFacet.prototype, "dependsOn", void 0);
AtomicRatingFacet.style = atomicRatingFacetCss;

export { AtomicRatingFacet as atomic_rating_facet };

//# sourceMappingURL=atomic-rating-facet.entry.js.map