import { e as getAssetPath } from './index-53978573.js';
...
function sanitizeStyle(style) {
    var _a;
    const purifiedOuterHTML = purify.exports.sanitize(`<style>${style}</style>`, {
        ALLOWED_TAGS: ['style'],
        ALLOWED_ATTR: [],
        FORCE_BODY: true,
    });
...
export { DOMPurify as D, camelToKebab as a, isElementNode as b, closest as c, defer as d, isVisualNode as e, aggregate as f, getRandomArbitrary as g, containsVisualElement as h, isInDocument as i, elementHasAncestorTag as j, kebabToCamel as k, sortByDocumentPosition as l, sanitizeStyle as m, purify as n, once as o, parseXML as p, getFocusedElement as q, randomID as r, snakeToCamel as s, titleToKebab as t, isAncestorOf as u, getParent as v, parseAssetURL as w };

//# sourceMappingURL=utils-8200d0ae.js.map