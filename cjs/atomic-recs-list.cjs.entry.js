...
const carousel = require('./carousel-46420299.js');
...
const AtomicRecsList = class {
    ...
    initialize() {
        ...
        this.recommendationList = headless_esm.Fh(this.bindings.engine, {
            options: {
    ...
    updateOriginLevel2() {
        if (this.label) {
            const action = headless_esm.Ox(this.bindings.engine).setOriginLevel2({
    ...
    renderHeading() {
        ...
        return (index.h(heading.Heading, { level: this.headingLevel, part: "label", class: "m-0 mb-2" }, this.bindings.i18n.t(this.label)));
    }
    get currentIndex() {
    ...
    getPropsForAtomicRecsResult(recommendation) {
        return {
            interactiveResult: headless_esm.Oh(this.bindings.engine, {
    ...
    computeListDisplayClasses() {
        ...
        return displayOptions.getItemListDisplayClasses('grid', this.density, this.imageSize, this.recommendationListState.isLoading, displayPlaceholders);
    }
    renderAsGrid(recommendation, i) {
        const propsForAtomicRecsResult = this.getPropsForAtomicRecsResult(recommendation);
        return (index.h(displayGrid.DisplayGrid, { item: recommendation, ...propsForAtomicRecsResult.interactiveResult, setRef: (element) => element && this.itemListCommon.setNewResultRef(element, i) }, index.h("atomic-recs-result", { ...propsForAtomicRecsResult })));
    }
    renderListOfRecommendations() {
        ...
        return (index.h(itemDisplayGuard.DisplayWrapper, { listClasses: listClasses, display: "grid" }, index.h(placeholders.ResultsPlaceholdersGuard, { density: this.density, display: this.display, imageSize: this.imageSize, displayPlaceholders: !this.bindings.store.isAppLoaded(), numberOfPlaceholders: (_a = this.numberOfRecommendationsPerPage) !== null && _a !== void 0 ? _a : this.numberOfRecommendations }), index.h(itemDisplayGuard.ItemDisplayGuard, { ...this.recommendationListStateWithAugment }, this.subsetRecommendations.map((recommendation, i) => {
            return this.renderAsGrid(recommendation, i);
        }))));
    }
    render() {
        return (index.h(index.Fragment, { key: 'fd66b07dd3977ac306881db5ef378917caad0632' }, this.renderHeading(), this.shouldRenderPagination ? (index.h(carousel.Carousel, { bindings: this.bindings, currentPage: this.currentPage, nextPage: () => this.nextPage(), previousPage: () => this.previousPage(), numberOfPages: this.numberOfPages }, this.renderListOfRecommendations())) : (this.renderListOfRecommendations())));
    }
...
__decorate([
    initializationUtils.BindStateToController('recommendationList')
], AtomicRecsList.prototype, "recommendationListState", void 0);
AtomicRecsList.style = AtomicRecsListStyle0;

exports.atomic_recs_list = AtomicRecsList;

//# sourceMappingURL=atomic-recs-list.cjs.entry.js.map