...
const AtomicCitation = class {
    ...
    renderPopover() {
        return (index.h("div", { part: "citation-popover", class: `rounded-md border border-neutral p-4 shadow z-10 bg-background ${this.isOpen ? 'desktop-only:flex' : 'hidden'} flex-col gap-3 mobile-only:hidden`, ref: (el) => (this.popupRef = el), role: "dialog" }, index.h("div", { class: "truncate text-neutral-dark text-sm" }, this.citation.uri), index.h(heading.Heading, { level: 0, class: "font-bold text-md" }, this.citation.title), index.h("p", { class: "text-on-background text-sm" }, this.getTruncatedText())));
    }
    render() {
        var _a;
        return (index.h("div", { key: '8fb37eb0279374ab1172f72baf1bbdea7612434e', class: "relative" }, index.h(itemLink.LinkWithItemAnalytics, { key: '7272e07afc9cdc456bb81705bf121973bf914f66', href: (_a = this.citation.clickUri) !== null && _a !== void 0 ? _a : this.citation.uri, ref: (el) => (this.citationRef = el), part: "citation", target: "_blank", rel: "noopener", "aria-haspopup": "dialog", className: "flex items-center p-1 bg-background btn-outline-primary border rounded-full border-neutral text-on-background", onSelect: () => this.interactiveCitation.select(), onBeginDelayedSelect: () => this.interactiveCitation.beginDelayedSelect(), onCancelPendingSelect: () => this.interactiveCitation.cancelPendingSelect(), stopPropagation: this.stopPropagation, onMouseLeave: this.closePopover, onMouseOver: this.delayedPopoverOpen, onFocus: this.openPopover, onBlur: this.closePopover }, index.h("div", { key: '0e86544b60faad1b0b59abf17d5b0f05ac6bed8d', part: "citation-index", class: "rounded-full font-medium flex items-center text-bg-primary shrink-0" }, index.h("div", { key: 'a5bbc6dd192ce5569da83d077bfffaf3bf1d12f9', class: "mx-auto" }, this.index + 1)), index.h("span", { key: '87cd6d189458d463ef4b503dc3d0c0be87bccc41', class: "citation-title truncate mx-1" }, this.citation.title)), this.renderPopover()));
    }
