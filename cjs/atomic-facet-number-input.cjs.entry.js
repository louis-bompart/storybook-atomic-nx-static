...
const FacetNumberInput = class {
    ...
    render() {
        ...
        return (index.h("form", { key: '864a8a1396b9f6e08537109ba752c58ae17c0974', class: "mt-4 px-2 gap-y-0.5", part: "input-form", onSubmit: (e) => {
                e.preventDefault();
                this.apply();
                return false;
            } }, index.h("label", { key: '62c2aa56bd2e2bdb8936b29c36591e24c836dc90', part: "label-start", class: labelClasses, htmlFor: `${this.filterState.facetId}_start` }, minText), index.h("input", { key: '1fb4d282c4c5d3fc3ea1302f00e5d7cd82f5e759', part: "input-start", id: `${this.filterState.facetId}_start`, type: "number", step: step, ref: (ref) => (this.startRef = ref), class: inputClasses, "aria-label": minAria, required: true, min: Number.MIN_SAFE_INTEGER, max: this.end, value: (_a = this.filterState.range) === null || _a === void 0 ? void 0 : _a.start, onInput: (e) => (this.start = e.target.valueAsNumber) }), index.h("label", { key: 'd8a938ecad188bc2a4738b7fd4c2234d8f4d244f', part: "label-end", class: labelClasses, htmlFor: `${this.filterState.facetId}_end` }, maxText), index.h("input", { key: 'caeba5358d2612b72506aa24e988210f817a020f', part: "input-end", id: `${this.filterState.facetId}_end`, type: "number", step: step, ref: (ref) => (this.endRef = ref), class: inputClasses, "aria-label": maxAria, required: true, min: this.start, max: Number.MAX_SAFE_INTEGER, value: (_b = this.filterState.range) === null || _b === void 0 ? void 0 : _b.end, onInput: (e) => (this.end = e.target.valueAsNumber) }), index.h(button.Button, { key: 'a04e26bca3e3b06f4261e13031943bea00f49e5d', style: "outline-primary", type: "submit", part: "input-apply-button", class: "p-2.5 flex-none truncate", ariaLabel: applyAria, text: apply })));
    }
};
