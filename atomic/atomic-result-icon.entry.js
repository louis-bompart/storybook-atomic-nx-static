...
import { s as snakeToCamel } from './utils-8200d0ae.js';
...
const AtomicResultIcon = class {
    ...
    get icon() {
        const fileTypeValue = ResultTemplatesHelpers.getResultProperty(this.result, 'filetype');
        const objectTypeValue = ResultTemplatesHelpers.getResultProperty(this.result, 'objecttype');
...
AtomicResultIcon.style = atomicResultIconCss;
