...
import { H as loadSearchConfigurationActions, I as loadQueryActions, J as getOrganizationEndpoints, K as EcommerceDefaultFieldsToInclude, L as loadFieldActions, M as buildSearchEngine, N as buildUrlManager, d as buildSearchStatus } from './headless.esm-bdb53e72.js';
...
const AtomicSearchInterface = class {
    ...
    registerFieldsToInclude() {
        var _a;
        (_a = this.engine) === null || _a === void 0 ? void 0 : _a.dispatch(loadFieldActions(this.engine).registerFieldsToInclude(this.store.state.fieldsToInclude));
    }
...
AtomicSearchInterface.style = atomicSearchInterfaceCss;
