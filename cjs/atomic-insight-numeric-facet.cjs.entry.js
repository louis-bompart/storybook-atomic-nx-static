...
require('./facet-values-group-d3a702ab.js');
...
const AtomicInsightNumericFacet = class {
    constructor(hostRef) {
    ...
    initializeFacetForInput() {
        ...
        this.facetForInput = headless_esm.jw(this.bindings.engine, {
            options: {
    ...
    initializeFacetForRange() {
        ...
        this.manualRanges = Array.from(this.host.querySelectorAll('atomic-numeric-range')).map(({ start, end, endInclusive, label }) => ({
            ...headless_esm.Zd({ start, end, endInclusive }),
            label,
        }));
        this.facetForRange = headless_esm.jw(this.bindings.engine, {
            options: {
    ...
    initializeFilter() {
        ...
        this.filter = headless_esm.Gw(this.bindings.engine, {
            options: {
    ...
    initializeDependenciesManager() {
        var _a, _b;
        this.dependenciesManager = headless_esm.MP(this.bindings.engine, {
    ...
    initializeSearchStatus() {
        this.searchStatus = headless_esm.IP(this.bindings.engine);
    }
    registerFacetToStore() {
        ...
        this.bindings.store.registerFacet('numericFacets', {
            ...facetInfo,
            format: (value) => valuesContainer.formatHumanReadable({
                facetValue: value,
    ...
    applyNumberInput() {
        this.facetId &&
            this.bindings.engine.dispatch(headless_esm.Kz(this.bindings.engine).deselectAllNumericFacetValues(this.facetId));
    }
    render() {
        ...
        return (index.h(facetGuard.FacetGuard, { key: '51dab34b356466854f02cf7711c0143ec74e999b', enabled: this.enabled, firstSearchExecuted: firstSearchExecuted, hasError: hasError, hasResults: this.shouldRenderFacet }, firstSearchExecuted ? (index.h(facetPlaceholder.FacetContainer, null, index.h(facetPlaceholder.FacetHeader, { i18n: i18n, label: label, onClearFilters: () => {
            ...
            this.shouldRenderInput && (index.h("atomic-facet-number-input", { type: withInput, bindings: this.bindings, label: label, filter: filter, filterState: filter.state })),
    ...
    renderValues() {
        ...
        return (index.h(valuesContainer.NumericFacetValuesContainer, { i18n: i18n, label: label }, this.valuesToRender.map((value) => (index.h(valuesContainer.NumericFacetValueLink, { formatter: this.formatter, displayValuesAs: displayValuesAs, facetValue: value, field: field, i18n: i18n, logger: logger, manualRanges: manualRanges, onClick: () => this.displayValuesAs === 'link'
    ...
    computeFacetId() {
        ...
        if (this.bindings.store.get('numericFacets')[this.field]) {
            this.facetId = utils.randomID(`${this.field}_`);
        }
    ...
    validateProps() {
        new bueno_esm.Schema({
            displayValuesAs: new bueno_esm.StringValue({ constrainTo: ['checkbox', 'link'] }),
            withInput: new bueno_esm.StringValue({ constrainTo: ['integer', 'decimal'] }),
        }).validate({
...
], AtomicInsightNumericFacet.prototype, "bindings", void 0);
__decorate([
    initializationUtils.BindStateToController('facetForRange')
], AtomicInsightNumericFacet.prototype, "facetState", void 0);
__decorate([
    initializationUtils.BindStateToController('filter')
], AtomicInsightNumericFacet.prototype, "filterState", void 0);
__decorate([
    initializationUtils.BindStateToController('searchStatus')
], AtomicInsightNumericFacet.prototype, "searchStatusState", void 0);
__decorate([
    initializationUtils.BindStateToController('facetForInput')
], AtomicInsightNumericFacet.prototype, "facetForInputState", void 0);
__decorate([
    propsUtils.MapProp()
], AtomicInsightNumericFacet.prototype, "dependsOn", void 0);
AtomicInsightNumericFacet.style = AtomicInsightNumericFacetStyle0;

exports.atomic_insight_numeric_facet = AtomicInsightNumericFacet;

//# sourceMappingURL=atomic-insight-numeric-facet.cjs.entry.js.map