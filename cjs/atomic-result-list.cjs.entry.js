...
const AtomicResultList = class {
    ...
    render() {
        ...
        return (index.h(itemListGuard.ItemListGuard, { key: '14f45d97c7d629b69a44e741a6ae99e727c0fc65', hasError: this.resultListState.hasError, hasTemplate: this.resultTemplateRegistered, templateHasError: this.itemTemplateProvider.hasError, firstRequestExecuted: this.resultListState.firstSearchExecuted, hasItems: this.resultListState.hasResults }, index.h(itemDisplayGuard.DisplayWrapper, { key: 'ae267dfd3358fd0367bf86b675b9ea0895fae870', display: this.display, listClasses: listClasses }, index.h(placeholders.ResultsPlaceholdersGuard, { key: '970abf6519fa2a1c7a90a93d88f9975a83277406', density: this.density, display: this.display, imageSize: this.imageSize, displayPlaceholders: !this.bindings.store.isAppLoaded(), numberOfPlaceholders: this.resultsPerPageState.numberOfResults }), index.h(itemDisplayGuard.ItemDisplayGuard, { key: '8c52394d9cad0fc6574cf013e505a6c9b70dfd6d', firstRequestExecuted: this.resultListState.firstSearchExecuted, hasItems: this.resultListState.hasResults }, this.display === 'table'
            ? this.renderAsTable()
            : this.display === 'grid'
                ? this.renderAsGrid()
                : this.renderAsList()))));
