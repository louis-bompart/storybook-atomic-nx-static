...
import { j as jw, Z as Zd, G as Gw, M as MP, I as IP, K as Kz } from './headless.esm3.js';
...
const AtomicInsightNumericFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicInsightNumericFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    initializeFacetForInput() {
        ...
        this.facetForInput = jw(this.bindings.engine, {
            options: {
    ...
    initializeFacetForRange() {
        ...
        this.manualRanges = Array.from(this.host.querySelectorAll('atomic-numeric-range')).map(({ start, end, endInclusive, label }) => ({
            ...Zd({ start, end, endInclusive }),
            label,
        }));
        this.facetForRange = jw(this.bindings.engine, {
            options: {
    ...
    initializeFilter() {
        ...
        this.filter = Gw(this.bindings.engine, {
            options: {
    ...
    initializeDependenciesManager() {
        var _a, _b;
        this.dependenciesManager = MP(this.bindings.engine, {
    ...
    applyNumberInput() {
        this.facetId &&
            this.bindings.engine.dispatch(Kz(this.bindings.engine).deselectAllNumericFacetValues(this.facetId));
    }
    render() {
        ...
        return (h(FacetGuard, { key: '51dab34b356466854f02cf7711c0143ec74e999b', enabled: this.enabled, firstSearchExecuted: firstSearchExecuted, hasError: hasError, hasResults: this.shouldRenderFacet }, firstSearchExecuted ? (h(FacetContainer, null, h(FacetHeader, { i18n: i18n, label: label, onClearFilters: () => {
            ...
            }, numberOfActiveValues: numberOfSelectedValues, isCollapsed: isCollapsed, headingLevel: headingLevel, onToggleCollapse: () => (this.isCollapsed = !this.isCollapsed), headerRef: (el) => focusTarget.setTarget(el) }), !isCollapsed && [
            this.shouldRenderValues && this.renderValues(),
            this.shouldRenderInput && (h("atomic-facet-number-input", { type: withInput, bindings: this.bindings, label: label, filter: filter, filterState: filter.state })),
        ])) : (h(FacetPlaceholder, { isCollapsed: this.isCollapsed, numberOfValues: this.numberOfValues }))));
    }
    renderValues() {
        const { displayValuesAs, field, manualRanges, label, bindings: { i18n, engine: { logger }, }, } = this;
        return (h(NumericFacetValuesContainer, { i18n: i18n, label: label }, this.valuesToRender.map((value) => (h(NumericFacetValueLink, { formatter: this.formatter, displayValuesAs: displayValuesAs, facetValue: value, field: field, i18n: i18n, logger: logger, manualRanges: manualRanges, onClick: () => this.displayValuesAs === 'link'
    ...
    static get style() { return AtomicInsightNumericFacetStyle0; }
}, [1, "atomic-insight-numeric-facet", {
...
__decorate([
    InitializeBindings()
], AtomicInsightNumericFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facetForRange')
], AtomicInsightNumericFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('filter')
], AtomicInsightNumericFacet$1.prototype, "filterState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicInsightNumericFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    BindStateToController('facetForInput')
], AtomicInsightNumericFacet$1.prototype, "facetForInputState", void 0);
__decorate([
    MapProp()
], AtomicInsightNumericFacet$1.prototype, "dependsOn", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-insight-numeric-facet", "atomic-component-error", "atomic-facet-number-input", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-insight-numeric-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicInsightNumericFacet$1);
            }
            break;
...
const AtomicInsightNumericFacet = AtomicInsightNumericFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicInsightNumericFacet, defineCustomElement };

//# sourceMappingURL=atomic-insight-numeric-facet.js.map