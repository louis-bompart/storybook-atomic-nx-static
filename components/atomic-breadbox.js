...
import { r as rO, Z as Zk } from './headless.esm.js';
...
const SEPARATOR = ' / ';
const ELLIPSIS = '...';
const AtomicBreadbox$1 = /*@__PURE__*/ proxyCustomElement(class AtomicBreadbox extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    renderBreadcrumb(breadcrumb, index, totalBreadcrumbs) {
        ...
        return (h("li", { class: "breadcrumb", key: value }, h(Button, { part: "breadcrumb-button", style: isExclusion ? 'outline-error' : 'outline-bg-neutral', class: classNames.join(' '), title: title,
            ...
            } }, h("span", { part: "breadcrumb-label", class: `max-w-snippet truncate group-hover:text-${activeColor} group-focus-visible:text-${activeColor} ${breadcrumb.state}` }, this.bindings.i18n.t('with-colon', { text: breadcrumb.label })), h("span", { part: "breadcrumb-value", class: breadcrumb.content
                ? ''
                : `max-w-snippet truncate ${breadcrumb.state}` }, (_a = breadcrumb.content) !== null && _a !== void 0 ? _a : value), h("atomic-icon", { part: "breadcrumb-clear", class: "w-2.5 h-2.5 ml-2 mt-px", icon: CloseIcon }))));
    }
    ...
    renderShowMore() {
        return (h("li", { key: "show-more" }, h(Button, { ref: (ref) => {
    ...
    renderShowLess() {
        return (h("li", { key: "show-less" }, h(Button, { ref: (ref) => (this.showLess = ref), part: "show-less", style: "outline-primary", text: this.bindings.i18n.t('show-less'), class: "p-2 btn-pill", onClick: () => {
    ...
    renderClearAll() {
        ...
        return (h("li", { key: "clear-all" }, h(Button, { part: "clear", style: "text-primary", text: this.bindings.i18n.t('clear'), class: "p-2 btn-pill", ariaLabel: this.bindings.i18n.t('clear-all-filters'), onClick: async () => {
                var _a;
    ...
    get categoryFacetBreadcrumbs() {
        return this.breadcrumbManagerState.categoryFacetBreadcrumbs.map(({ facetId, field, path, deselect }) => ({
            ...
            deselect: deselect,
            formattedValue: path.map((pathValue) => getFieldValueCaption(field, pathValue.value, this.bindings.i18n)),
        }));
    }
    ...
    render() {
        ...
        return (h("div", { part: "container", class: "text-on-background text-sm flex" }, h("span", { part: "label", class: "font-bold py-[0.625rem] pl-0 pr-2" }, this.bindings.i18n.t('with-colon', {
            text: this.bindings.i18n.t('filters'),
        })), h("div", { part: "breadcrumb-list-container", class: "relative grow" }, h("ul", { part: "breadcrumb-list", class: `flex gap-1 ${this.isCollapsed ? 'flex-nowrap absolute w-full' : 'flex-wrap'}` }, this.renderBreadcrumbs(allBreadcrumbs)))));
    }
    componentDidRender() {
        this.adaptBreadcrumbs();
    }
    get host() { return this; }
    static get style() { return AtomicBreadboxStyle0; }
}, [1, "atomic-breadbox", {
        "pathLimit": [2, "path-limit"],
        "breadcrumbManagerState": [32],
...
__decorate([
    InitializeBindings()
], AtomicBreadbox$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('breadcrumbManager')
], AtomicBreadbox$1.prototype, "breadcrumbManagerState", void 0);
__decorate([
    BindStateToController('facetManager')
], AtomicBreadbox$1.prototype, "facetManagerState", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-breadbox", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-breadbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicBreadbox$1);
            }
            break;
...
const AtomicBreadbox = AtomicBreadbox$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicBreadbox, defineCustomElement };

//# sourceMappingURL=atomic-breadbox.js.map