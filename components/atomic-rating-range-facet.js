...
const AtomicRatingRangeFacet$1 = /*@__PURE__*/ proxyCustomElement(class AtomicRatingRangeFacet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    ratingContent(facetValue) {
        return (h("div", { class: "flex items-center" }, h(Rating, { i18n: this.bindings.i18n, numberOfTotalIcons: this.maxValueInIndex, numberOfActiveIcons: facetValue.start, icon: this.icon }), this.renderLabelText(facetValue)));
    }
    renderHeader() {
    ...
    renderLabelText(facetValue) {
        return (h("span", { part: "value-label", class: `ml-1 flex items-center truncate group-focus:text-primary group-hover:text-primary ${facetValue.state === 'selected' ? 'font-bold' : ''}` }, facetValue.start === this.maxValueInIndex ? (h("span", null, this.bindings.i18n.t('only'))) : (this.bindings.i18n.t('and-up'))));
    }
    ...
    renderValues() {
        return this.renderValuesContainer(this.valuesToRender.map((value) => this.renderValue(value, () => this.facet.toggleSingleSelect(value))));
    }
    get valuesToRender() {
    ...
    static get style() { return AtomicRatingRangeFacetStyle0; }
}, [1, "atomic-rating-range-facet", {
...
__decorate([
    InitializeBindings()
], AtomicRatingRangeFacet$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('facet')
], AtomicRatingRangeFacet$1.prototype, "facetState", void 0);
__decorate([
    BindStateToController('searchStatus')
], AtomicRatingRangeFacet$1.prototype, "searchStatusState", void 0);
__decorate([
    MapProp()
], AtomicRatingRangeFacet$1.prototype, "dependsOn", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-rating-range-facet", "atomic-component-error", "atomic-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-rating-range-facet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicRatingRangeFacet$1);
            }
            break;
...
const AtomicRatingRangeFacet = AtomicRatingRangeFacet$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicRatingRangeFacet, defineCustomElement };

//# sourceMappingURL=atomic-rating-range-facet.js.map