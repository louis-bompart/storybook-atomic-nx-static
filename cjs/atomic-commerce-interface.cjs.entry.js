...
function createAtomicCommerceStore() {
...
const AtomicCommerceInterface = class {
    ...
    connectedCallback() {
        ...
        this.i18n.addResourceBundle = (lng, ns, resources, deep, overwrite) => this.addResourceBundle(lng, ns, resources, deep, overwrite);
    }
    componentWillLoad() {
        if (this.CspNonce) {
    ...
    async executeFirstSearch() {
        ...
        this.engine.dispatch(headless_esm.Mt({ query: value }));
        this.engine.executeFirstSearch();
    }
    /**
    ...
    async getOrganizationEndpoints(organizationId, env = 'prod') {
        return headless_esm.No(organizationId, env);
    }
    get bindings() {
        return {
            engine: this.engine,
    ...
    initSearchStatus() {
        if (this.type === 'product-listing') {
            this.searchStatus = headless_esm.zF(this.engine);
        }
...
AtomicCommerceInterface.style = AtomicCommerceInterfaceStyle0;

exports.atomic_commerce_interface = AtomicCommerceInterface;

//# sourceMappingURL=atomic-commerce-interface.cjs.entry.js.map