...
function highlightSearchResult(resultValue, searchQuery = '') {
    ...
    const regex = new RegExp(`(${stringUtils.regexEncode(searchQuery)})`, 'i');
...
const FacetValueLabelHighlight = (props) => {
    ...
    index.h("span", { title: props.displayValue, part: "value-label", class: `value-label truncate peer-hover:text-error ${props.isSelected || !!props.isExcluded ? 'font-bold' : ''}`, innerHTML: highlightSearchResult(props.displayValue, props.searchQuery) }));
};

exports.FacetValueLabelHighlight = FacetValueLabelHighlight;
exports.escapeHtml_1 = escapeHtml_1;
exports.shouldDisplaySearchResults = shouldDisplaySearchResults;
exports.shouldUpdateFacetSearchComponent = shouldUpdateFacetSearchComponent;

//# sourceMappingURL=facet-value-label-highlight-e1da136a.js.map