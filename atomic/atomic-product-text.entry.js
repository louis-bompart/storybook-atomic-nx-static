...
import { P as ProductTemplatesHelpers } from './headless.esm-628c1e39.js';
...
import { P as ProductContext } from './product-template-decorators-350e3d33.js';
...
const AtomicProductText = class {
    ...
    possiblyWarnOnBadFieldType() {
        const productValueRaw = ProductTemplatesHelpers.getProductProperty(this.product, this.field);
        if (lodash$1.exports.isArray(productValueRaw)) {
            this.bindings.engine.logger.error(`atomic-product-text cannot be used with multi value field "${this.field}" with values "${productValueRaw}".`, this);
        }
    }
    render() {
        ...
        if (!productValueAsString && this.default) {
            this.possiblyWarnOnBadFieldType();
            return (h("atomic-commerce-text", { value: getFieldValueCaption(this.field, productValueAsString !== null && productValueAsString !== void 0 ? productValueAsString : this.default, this.bindings.i18n) }));
        }
        if (productValueAsString !== null) {
            this.possiblyWarnOnBadFieldType();
            return (h("atomic-commerce-text", { value: getFieldValueCaption(this.field, productValueAsString, this.bindings.i18n) }));
        }
    }
...
export { AtomicProductText as atomic_product_text };

//# sourceMappingURL=atomic-product-text.entry.js.map