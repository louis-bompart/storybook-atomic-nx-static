...
import { u as iO, v as jm } from './headless.esm.js';
...
import { C as ClearIcon } from './clear.js';
...
import { d as defineCustomElement$5 } from './atomic-focus-detector2.js';
...
import { d as defineCustomElement$2 } from './atomic-search-box-recent-queries2.js';

const ClearButton = ({ inputRef, bindings, onClick, ...defaultButtonProps }) => (h(Button, { style: "text-transparent", part: "clear-button", class: "w-8 h-8 mr-1.5 text-neutral-dark shrink-0", onClick: () => {
        onClick === null || onClick === void 0 ? void 0 : onClick();
        inputRef === null || inputRef === void 0 ? void 0 : inputRef.focus();
    }, ariaLabel: bindings.i18n.t('clear'), ...defaultButtonProps },
    h("atomic-icon", { part: "clear-icon", icon: ClearIcon, class: "w-3 h-3" })));
...
const SearchInput = ({ inputRef, loading, bindings, onKeyDown, value, ariaLabel, onClear, popup, ...defaultInputProps }) => (h("div", { class: "grow flex items-center" },
    h("input", { part: "input", "aria-label": ariaLabel, placeholder: bindings.i18n.t('search'), type: "text", class: "h-full outline-none bg-transparent w-0 grow px-4 py-3.5 text-neutral-dark placeholder-neutral-dark text-lg", onKeyDown: (e) => {
            onKeyDown === null || onKeyDown === void 0 ? void 0 : onKeyDown(e);
        }, ...(popup && getPopupAttributes(popup)), ...defaultInputProps, value: value }),
    loading && (h("span", { part: "loading", class: "loading w-5 h-5 rounded-full bg-gradient-to-r animate-spin mr-3 grid place-items-center" })),
    !loading && value && (h(ClearButton, { inputRef: inputRef, bindings: bindings, onClick: () => onClear() }))));

const SubmitButton = ({ bindings, onClick, ...defaultButtonProps }) => (h(Button, { style: "primary", class: "flex items-center justify-center w-12 h-auto rounded-r-md rounded-l-none -my-px -mr-px shrink-0", part: "submit-button", ariaLabel: bindings.i18n.t('search'), onClick: () => {
        onClick === null || onClick === void 0 ? void 0 : onClick();
    }, ...defaultButtonProps },
    h("atomic-icon", { part: "submit-icon", icon: SearchIcon, class: "w-4 h-4" })));
...
const AtomicSearchBox$1 = /*@__PURE__*/ proxyCustomElement(class AtomicSearchBox extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
        ...
        this.renderTextBox = (searchLabel) => {
            ...
            return this.textarea ? (h(SearchTextArea, { textAreaRef: this.textAreaRef, ref: (el) => (this.textAreaRef = el), ...props, onClear: () => {
                    props.onClear();
                    this.triggerTextAreaChange('');
                } })) : (h(SearchInput, { inputRef: this.inputRef, ref: (el) => (this.inputRef = el), ...props }));
        };
    ...
    initialize() {
        ...
        this.searchBox = this.redirectionUrl
            ? iO(this.bindings.engine, {
                options: {
                    ...this.searchBoxOptions,
                    redirectionUrl: this.redirectionUrl,
                },
            })
            : jm(this.bindings.engine, {
    ...
    static get style() { return AtomicSearchBoxStyle0; }
}, [1, "atomic-search-box", {
...
__decorate([
    InitializeBindings()
], AtomicSearchBox$1.prototype, "bindings", void 0);
__decorate([
    BindStateToController('searchBox')
], AtomicSearchBox$1.prototype, "searchBoxState", void 0);
__decorate([
    AriaLiveRegion('search-box')
], AtomicSearchBox$1.prototype, "searchBoxAriaMessage", void 0);
__decorate([
    AriaLiveRegion('search-suggestions', true)
], AtomicSearchBox$1.prototype, "suggestionsAriaMessage", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-search-box", "atomic-component-error", "atomic-focus-detector", "atomic-icon", "atomic-search-box-query-suggestions", "atomic-search-box-recent-queries"];
...
const AtomicSearchBox = AtomicSearchBox$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicSearchBox, defineCustomElement };

//# sourceMappingURL=atomic-search-box.js.map