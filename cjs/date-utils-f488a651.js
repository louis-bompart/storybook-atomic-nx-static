...
dayjs_min.dayjs.extend(customParseFormat);
function parseDate(date, format) {
    const parsedDate = dayjs_min.dayjs(date, format);
    if (!parsedDate.isValid() && !format) {
        return dayjs_min.dayjs(date, headless_esm.ss);
    }
    return parsedDate;
}
...
//# sourceMappingURL=date-utils-f488a651.js.map