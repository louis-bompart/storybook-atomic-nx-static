...
const ColorFacetCheckbox = (props, children) => {
    ...
    return (index.h("li", { key: props.displayValue, class: "relative flex items-center" },
        index.h("button", { id: id, role: "checkbox", part: `value-checkbox value-${partValue}${props.isSelected ? ' value-checkbox-checked' : ''}`, onClick: () => props.onClick(), onMouseDown: (e) => ripple.createRipple(e, { color: 'neutral', parent: labelRef }), "aria-checked": props.isSelected.toString(), class: `value-checkbox ${props.isSelected ? 'ring-primary' : ''}`, "aria-label": ariaLabel }),
        index.h("label", { ref: (ref) => (labelRef = ref), htmlFor: id, part: "value-checkbox-label", onMouseDown: (e) => ripple.createRipple(e, { color: 'neutral' }) },
            children,
...
const AtomicColorFacet = class {
    ...
    initialize() {
        ...
        this.facet = headless_esm.jE(this.bindings.engine, { options: this.facetOptions });
    ...
    renderHeader() {
        return (index.h(facetPlaceholder.FacetHeader, { i18n: this.bindings.i18n, label: this.label, onClearFilters: () => {
    ...
    renderValue(facetValue, onClick, isShowLessFocusTarget, isShowMoreFocusTarget) {
        const displayValue = fieldUtils.getFieldValueCaption(this.facetId, facetValue.value, this.bindings.i18n);
        ...
        switch (this.displayValuesAs) {
            case 'checkbox':
                return (index.h(ColorFacetCheckbox, { displayValue: displayValue, numberOfResults: facetValue.numberOfResults, isSelected: isSelected, i18n: this.bindings.i18n, onClick: onClick, searchQuery: this.facetState.facetSearch.query, buttonRef: (element) => {
                    ...
                    } }, index.h(facetValueLabelHighlight.FacetValueLabelHighlight, { displayValue: displayValue, isSelected: isSelected, searchQuery: this.facetState.facetSearch.query })));
            case 'box':
                return (index.h(facetValueBox.FacetValueBox, { displayValue: displayValue, numberOfResults: facetValue.numberOfResults, isSelected: isSelected, i18n: this.bindings.i18n, onClick: onClick, searchQuery: this.facetState.facetSearch.query, buttonRef: (element) => {
                        isShowLessFocusTarget &&
                            this.focusTargets.showLessFocus.setTarget(element);
                        isShowMoreFocusTarget &&
                            this.focusTargets.showMoreFocus.setTarget(element);
                    } }, index.h("div", { part: `value-${partValueWithDisplayValue} value-${partValueWithAPIValue} default-color-value`, class: "value-box-color w-full h-12 bg-neutral-dark rounded-md mb-2" }), index.h(facetValueLabelHighlight.FacetValueLabelHighlight, { displayValue: displayValue, isSelected: isSelected, isExcluded: isExcluded, searchQuery: this.facetState.facetSearch.query })));
        }
    }
    renderValuesContainer(children, query) {
        const classes = `mt-3 ${this.displayValuesAs === 'box' ? 'box-color-container' : ''}`;
        return (index.h(facetValuesGroup.FacetValuesGroup, { i18n: this.bindings.i18n, label: this.label, query: query }, index.h("ul", { class: classes, part: "values" }, children)));
    }
    renderValues() {
    ...
    renderShowMoreLess() {
        return (index.h(facetShowMoreLess.FacetShowMoreLess, { label: this.label, i18n: this.bindings.i18n, onShowMore: () => {
    ...
    render() {
        ...
        if (!this.searchStatusState.firstSearchExecuted) {
            return (index.h(facetPlaceholder.FacetPlaceholder, { numberOfValues: this.numberOfValues, isCollapsed: this.isCollapsed }));
        }
        if (!this.facetState.values.length) {
            return index.h(initializationUtils.Hidden, null);
        }
        return (index.h(facetPlaceholder.FacetContainer, null, this.renderHeader(), !this.isCollapsed && [
            this.renderSearchInput(),
            facetValueLabelHighlight.shouldDisplaySearchResults(this.facetState.facetSearch)
...
exports.atomic_color_facet = AtomicColorFacet;

//# sourceMappingURL=atomic-color-facet.cjs.entry.js.map