...
const AtomicInsightResultTemplate$1 = /*@__PURE__*/ proxyCustomElement(class AtomicInsightResultTemplate extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "atomic-insight-result-template", {
        "conditions": [16],
...
], AtomicInsightResultTemplate$1.prototype, "mustMatch", void 0);
__decorate([
    MapProp({ splitValues: true })
], AtomicInsightResultTemplate$1.prototype, "mustNotMatch", void 0);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["atomic-insight-result-template"];
    components.forEach(tagName => { switch (tagName) {
        case "atomic-insight-result-template":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, AtomicInsightResultTemplate$1);
            }
            break;
    } });
}

const AtomicInsightResultTemplate = AtomicInsightResultTemplate$1;
const defineCustomElement = defineCustomElement$1;

export { AtomicInsightResultTemplate, defineCustomElement };

//# sourceMappingURL=atomic-insight-result-template.js.map