...
const AtomicCommerceSearchBox = class {
    constructor(hostRef) {
        ...
        this.renderTextBox = (searchLabel) => {
            ...
            return (index.h(searchSuggestion.SearchTextArea, { textAreaRef: this.textAreaRef, ref: (el) => (this.textAreaRef = el), ...props, onClear: () => {
                    props.onClear();
    ...
    initialize() {
        this.id = utils.randomID('atomic-commerce-search-box-');
        this.searchBox = this.redirectionUrl
            ? headless_esm.bA(this.bindings.engine, {
                options: {
                    ...this.searchBoxOptions,
                    redirectionUrl: this.redirectionUrl,
                },
            })
            : headless_esm.yu(this.bindings.engine, {
...
], AtomicCommerceSearchBox.prototype, "bindings", void 0);
__decorate([
    initializationUtils.BindStateToController('searchBox')
], AtomicCommerceSearchBox.prototype, "searchBoxState", void 0);
__decorate([
    accessibilityUtils.AriaLiveRegion('search-box')
], AtomicCommerceSearchBox.prototype, "searchBoxAriaMessage", void 0);
__decorate([
    accessibilityUtils.AriaLiveRegion('search-suggestions', true)
], AtomicCommerceSearchBox.prototype, "suggestionsAriaMessage", void 0);
AtomicCommerceSearchBox.style = AtomicCommerceSearchBoxStyle0;

exports.atomic_commerce_search_box = AtomicCommerceSearchBox;

//# sourceMappingURL=atomic-commerce-search-box.cjs.entry.js.map